...
Assert::throws(\RangeException::class, function () use (&$leap, &$outOfRangeCommonYear) { $leap->with((object) JsUndefined::strip(['year' => $outOfRangeCommonYear]), (object) ['overflow' => 'reject']); }, 'ISO year is used to apply overflow');
