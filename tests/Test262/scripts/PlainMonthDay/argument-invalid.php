...
Assert::throws(\RangeException::class, function () use (&$month, &$day, &$year) { return new \Calendrics\Spec\PlainMonthDay($month, $day, null, $year); }, "year={$year}, month={$month}, day={$day}");
}
