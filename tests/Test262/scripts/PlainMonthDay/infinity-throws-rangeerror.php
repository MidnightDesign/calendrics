...
// Source: tests/Test262/data/PlainMonthDay/infinity-throws-rangeerror.js
...
Assert::throws(\RangeException::class, fn() => new \Calendrics\Spec\PlainMonthDay(INF, 1), '');
Assert::throws(\RangeException::class, fn() => new \Calendrics\Spec\PlainMonthDay(1, INF), '');
Assert::throws(\RangeException::class, fn() => new \Calendrics\Spec\PlainMonthDay(1, 1, 'iso8601', INF), '');
...
Assert::throws(\RangeException::class, function () use (&$args_) { return new \Calendrics\Spec\PlainMonthDay(...$args_); }, $description);
