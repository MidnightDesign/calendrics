...
Assert::throws(\RangeException::class, fn() => new \Temporal\Spec\PlainMonthDay(INF, 1), '');
Assert::throws(\RangeException::class, fn() => new \Temporal\Spec\PlainMonthDay(1, INF), '');
Assert::throws(\RangeException::class, fn() => new \Temporal\Spec\PlainMonthDay(1, 1, 'iso8601', INF), '');
