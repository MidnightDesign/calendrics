...
$leapDay = new \Calendrics\Spec\PlainMonthDay(2, 29);
...
$beforeEpoch = new \Calendrics\Spec\PlainMonthDay(12, 2, 'iso8601', 1920);
...
$afterEpoch = new \Calendrics\Spec\PlainMonthDay(1, 7, 'iso8601', 1980);
