...
// Source: tests/Test262/data/PlainMonthDay/from/argument-string-calendar-annotation-invalid-key.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainMonthDay::from($arg); }, "annotation keys must be lowercase: {$arg} - {$descr}");
}
