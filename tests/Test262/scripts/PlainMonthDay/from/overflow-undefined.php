...
$explicit = \Calendrics\Spec\PlainMonthDay::from($value, []);
TemporalHelpers::assertPlainMonthDay($explicit, 'M05', 2, 'overflow is ignored');
$implicit = \Calendrics\Spec\PlainMonthDay::from($value, []);
...
$explicit = \Calendrics\Spec\PlainMonthDay::from($propertyBag, []);
TemporalHelpers::assertPlainMonthDay($explicit, 'M12', 31, 'default overflow is constrain');
$implicit = \Calendrics\Spec\PlainMonthDay::from($propertyBag, []);
