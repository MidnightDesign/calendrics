...
$result = \Calendrics\Spec\PlainMonthDay::from(JsUndefined::strip(['month' => $month, 'day' => $daysInMonth]));
TemporalHelpers::assertPlainMonthDay($result, $monthCode, $daysInMonth, "month {$month}, day {$daysInMonth}");
$result = \Calendrics\Spec\PlainMonthDay::from(JsUndefined::strip(['monthCode' => $monthCode, 'day' => $daysInMonth]));
