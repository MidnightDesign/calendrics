...
// Source: tests/Test262/data/PlainMonthDay/from/no-fractional-minutes-hours.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainMonthDay::from($arg); }, "{$description} not allowed in time string");
}
