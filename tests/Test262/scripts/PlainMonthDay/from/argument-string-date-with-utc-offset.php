...
// Source: tests/Test262/data/PlainMonthDay/from/argument-string-date-with-utc-offset.js
...
$result = \Calendrics\Spec\PlainMonthDay::from($arg);
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainMonthDay::from($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainMonthDay");
}
