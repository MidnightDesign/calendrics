...
$result1 = \Calendrics\Spec\PlainMonthDay::from($arg);
TemporalHelpers::assertPlainMonthDay($result1, 'M12', 31, 'leap second is a valid ISO string for PlainMonthDay');
$result2 = \Calendrics\Spec\PlainMonthDay::from($arg, (object) ['overflow' => 'reject']);
...
$result3 = \Calendrics\Spec\PlainMonthDay::from($arg);
TemporalHelpers::assertPlainMonthDay($result3, 'M12', 31, 'second: 60 is ignored in property bag for PlainMonthDay');
$result4 = \Calendrics\Spec\PlainMonthDay::from($arg, (object) ['overflow' => 'reject']);
