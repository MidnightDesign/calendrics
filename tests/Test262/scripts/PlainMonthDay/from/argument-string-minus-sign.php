...
// Source: tests/Test262/data/PlainMonthDay/from/argument-string-minus-sign.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainMonthDay::from($arg); }, "variant minus sign: {$arg}");
}
