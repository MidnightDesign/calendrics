...
// Source: tests/Test262/data/PlainMonthDay/from/argument-string-unknown-annotation.js
...
TemporalHelpers::assertPlainMonthDay($result, 'M05', 2, "unknown annotation ({$description})");
}
