...
// Source: tests/Test262/data/PlainMonthDay/from/options-read-before-algorithmic-validation.js
...
Assert::throws(\RangeException::class, function () use (&$options) { \Calendrics\Spec\PlainMonthDay::from((object) ['monthCode' => 'M08L', 'day' => 14], $options); }, 'exception thrown when month code is invalid for calendar');
