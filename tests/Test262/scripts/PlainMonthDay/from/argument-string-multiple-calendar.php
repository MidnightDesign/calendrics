...
// Source: tests/Test262/data/PlainMonthDay/from/argument-string-multiple-calendar.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainMonthDay::from($arg); }, "reject more than one calendar annotation if any critical: {$arg}");
}
