...
// Source: tests/Test262/data/Now/zonedDateTimeISO/timezone-string-year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Calendrics\Spec\Now::zonedDateTimeISO($timeZone); }, 'reject minus zero as extended year');
}
