...
// Source: tests/Test262/data/Now/plainTimeISO/timezone-wrong-type.js
...
Assert::throws((is_string($timeZone) ? \RangeException::class : \TypeError::class), function () use (&$timeZone) { return \Calendrics\Spec\Now::plainTimeISO($timeZone); }, "{$description} does not convert to a valid ISO string");
}
...
[$timeZone, $description] = array_pad($__entry__, 2, null);
Assert::throws(\TypeError::class, function () use (&$timeZone) { return \Calendrics\Spec\Now::plainTimeISO($timeZone); }, "{$description} is not a valid object and does not convert to a string");
}
