...
// Source: tests/Test262/data/Now/plainTimeISO/timezone-string-year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Calendrics\Spec\Now::plainTimeISO($timeZone); }, 'reject minus zero as extended year');
}
