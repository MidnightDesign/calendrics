...
// Source: tests/Test262/data/Now/plainDateTimeISO/timezone-string-year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Calendrics\Spec\Now::plainDateTimeISO($timeZone); }, 'reject minus zero as extended year');
}
