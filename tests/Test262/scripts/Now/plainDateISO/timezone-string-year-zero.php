...
// Source: tests/Test262/data/Now/plainDateISO/timezone-string-year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Calendrics\Spec\Now::plainDateISO($timeZone); }, 'reject minus zero as extended year');
}
