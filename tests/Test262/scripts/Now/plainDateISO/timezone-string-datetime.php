...
// Source: tests/Test262/data/Now/plainDateISO/timezone-string-datetime.js
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Calendrics\Spec\Now::plainDateISO($timeZone); }, 'bare date-time string is not a time zone');
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Calendrics\Spec\Now::plainDateISO($timeZone); }, "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
...
\Calendrics\Spec\Now::plainDateISO($timeZone);
}
