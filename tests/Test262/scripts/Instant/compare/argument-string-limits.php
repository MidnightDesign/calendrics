...
// Source: tests/Test262/data/Instant/compare/argument-string-limits.js
...
\Calendrics\Spec\Instant::compare($arg, $instance);
\Calendrics\Spec\Instant::compare($instance, $arg);
}
...
Assert::throws(\RangeException::class, function () use (&$arg, &$instance) { return \Calendrics\Spec\Instant::compare($arg, $instance); }, "\"{$arg}\" is outside the representable range of Instant (first argument)");
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return \Calendrics\Spec\Instant::compare($instance, $arg); }, "\"{$arg}\" is outside the representable range of Instant (second argument)");
}
