...
// Source: tests/Test262/data/Instant/prototype/since/instant-string.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$str) { return $instance->since($str); }, 'bare date-time string is not an instant');
$str = '1970-01-01T00:00[UTC]';
Assert::throws(\RangeException::class, function () use (&$instance, &$str) { return $instance->since($str); }, 'date-time + IANA annotation is not an instant');
