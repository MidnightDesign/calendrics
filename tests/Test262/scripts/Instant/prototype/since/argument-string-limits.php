...
// Source: tests/Test262/data/Instant/prototype/since/argument-string-limits.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->since($arg); }, "\"{$arg}\" is outside the representable range of Instant");
}
