...
// Source: tests/Test262/data/Instant/prototype/toZonedDateTimeISO/timezone-string-leap-second.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$timeZone) { return $instance->toZonedDateTimeISO($timeZone); }, 'leap second in time zone name not valid');
