...
// Source: tests/Test262/data/Instant/prototype/toZonedDateTimeISO/timezone-string-datetime.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$timeZone) { return $instance->toZonedDateTimeISO($timeZone); }, 'bare date-time string is not a time zone');
...
Assert::throws(\RangeException::class, function () use (&$instance, &$timeZone) { return $instance->toZonedDateTimeISO($timeZone); }, "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
