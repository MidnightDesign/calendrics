...
$options = TemporalHelpers::propertyBagObserver($actual, (object) ['roundingIncrement' => 1, 'roundingMode' => 'halfExpand', 'largestUnit' => 'hours', 'smallestUnit' => 'minutes', 'additional' => true], 'options');
