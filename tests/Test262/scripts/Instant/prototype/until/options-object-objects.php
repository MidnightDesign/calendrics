...
$result1 = $instance->until(new \Calendrics\Spec\Instant(3_600_000_000_000), (object) []);
TemporalHelpers::assertDuration($result1, 0, 0, 0, 0, 0, 0, 3600, 0, 0, 0, 'options may be an empty plain object');
$result2 = $instance->until(new \Calendrics\Spec\Instant(3_600_000_000_000), function () {  });
