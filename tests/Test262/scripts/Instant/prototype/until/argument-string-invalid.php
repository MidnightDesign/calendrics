...
// Source: tests/Test262/data/Instant/prototype/until/argument-string-invalid.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->until($arg); }, "\"{$arg}\" should not be a valid ISO string for an Instant");
}
