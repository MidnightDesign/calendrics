...
$instance->toString(TemporalHelpers::propertyBagObserver($actual, ['fractionalSecondDigits' => 'auto', 'roundingMode' => 'halfExpand', 'smallestUnit' => 'millisecond', 'timeZone' => 'UTC'], 'options', ['timeZone']));
