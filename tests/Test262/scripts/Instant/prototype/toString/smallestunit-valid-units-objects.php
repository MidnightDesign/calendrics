...
Assert::throws(\RangeException::class, function () use (&$instant, &$smallestUnit) { return $instant->toString((object) JsUndefined::strip(['smallestUnit' => $smallestUnit])); }, "\"{$smallestUnit}\" is not a valid unit for the smallestUnit option");
}
