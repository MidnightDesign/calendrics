...
// Source: tests/Test262/data/Instant/from/argument-string-minus-sign.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\Instant::from($arg); }, "variant minus sign: {$arg}");
}
