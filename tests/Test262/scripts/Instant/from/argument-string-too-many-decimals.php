...
// Source: tests/Test262/data/Instant/from/argument-string-too-many-decimals.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { \Calendrics\Spec\Instant::from($arg); }, 'no more than 9 decimal places are allowed');
}
