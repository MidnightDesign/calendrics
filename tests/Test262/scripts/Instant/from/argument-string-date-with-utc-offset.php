...
// Source: tests/Test262/data/Instant/from/argument-string-date-with-utc-offset.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\Instant::from($arg); }, "\"{$arg}\" UTC offset without time is not valid for Instant");
}
