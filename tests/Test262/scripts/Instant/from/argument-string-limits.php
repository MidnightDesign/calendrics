...
// Source: tests/Test262/data/Instant/from/argument-string-limits.js
...
\Calendrics\Spec\Instant::from($arg);
}
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\Instant::from($arg); }, "\"{$arg}\" is outside the representable range of Instant");
}
