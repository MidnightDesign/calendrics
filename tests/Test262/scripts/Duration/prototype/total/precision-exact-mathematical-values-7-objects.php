...
$toNanos = (object) ['seconds' => 1_000_000_000, 'milliseconds' => 1_000_000, 'microseconds' => 1000, 'nanoseconds' => 1];
...
// Folded (BigInt 9007199254740991999999999 exceeds int64): maxTimeDuration
foreach (\Calendrics\Tests\Test262\Js::slice($units, 0, -1) as $unit) {
