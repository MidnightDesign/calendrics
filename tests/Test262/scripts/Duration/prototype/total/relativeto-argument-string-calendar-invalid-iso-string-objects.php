...
// Source: tests/Test262/data/Duration/prototype/total/relativeto-argument-string-calendar-invalid-iso-string.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->total((object) JsUndefined::strip(['unit' => 'months', 'relativeTo' => $arg])); }, "{$description} is not a valid calendar ID");
}
