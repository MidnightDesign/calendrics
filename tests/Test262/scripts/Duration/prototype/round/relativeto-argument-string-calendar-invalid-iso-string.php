...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->round(JsUndefined::strip(['largestUnit' => 'months', 'relativeTo' => $arg])); }, "{$description} is not a valid calendar ID");
}
