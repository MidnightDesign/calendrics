...
// Source: tests/Test262/data/Duration/prototype/round/relativeto-zoneddatetime-slots.js
...
$instance = new \Calendrics\Spec\Duration(0, 0, 0, 365);
$instance->round((object) JsUndefined::strip(['relativeTo' => $arg, 'largestUnit' => 'years']));
