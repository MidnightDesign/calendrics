...
$duration = new \Calendrics\Spec\Duration(0, 0, 0, 4, 12, 34, 56, 987, 654, 321);
TemporalHelpers::checkRoundingIncrementOptionWrongType(function ($roundingIncrement) use (&$duration) { return $duration->round((object) JsUndefined::strip(['smallestUnit' => 'second', 'roundingIncrement' => $roundingIncrement])); }, fn($result, $descr) => TemporalHelpers::assertDuration($result, 0, 0, 0, 4, 12, 34, 57, 0, 0, 0, $descr), fn($result, $descr) => TemporalHelpers::assertDuration($result, 0, 0, 0, 4, 12, 34, 56, 0, 0, 0, $descr));
