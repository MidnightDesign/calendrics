...
TemporalHelpers::assertDuration(\Calendrics\Spec\Duration::from($duration_desc)->round((object) ['relativeTo' => '2023-02-21', 'largestUnit' => 'month']), 0, 3, 0, 11, 0, 0, 0, 0, 0, 0, "rounding from {$unit}");
}
