...
$relativeTo = new \Calendrics\Spec\PlainDate(1972, 3, 1);
$options = JsUndefined::strip(['largestUnit' => 'years', 'relativeTo' => $relativeTo]);
$twoDaysLessThanFourYears = new \Calendrics\Spec\Duration(3, 11, 0, 27);
...
$oneDayLessThanFourYears = new \Calendrics\Spec\Duration(3, 11, 0, 28);
...
$fourYears = new \Calendrics\Spec\Duration(3, 11, 0, 29);
