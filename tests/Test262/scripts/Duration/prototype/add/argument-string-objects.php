...
$duration = \Calendrics\Spec\Duration::from((object) ['days' => 1, 'minutes' => 5]);
$result = $duration->add('P2DT5M');
TemporalHelpers::assertDuration($result, 0, 0, 0, 3, 0, 10, 0, 0, 0, 0, 'String argument should be supported');
Assert::throws(\RangeException::class, function () use (&$duration) { return $duration->add('2DT5M'); }, 'Invalid string argument should throw');
