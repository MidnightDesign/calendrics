...
Assert::throws(\RangeException::class, function () use (&$duration) { return $duration->toString(['smallestUnit' => 'hour', 'fractionalSecondDigits' => 5]); }, 'hour is an invalid smallestUnit but still overrides fractionalSecondDigits');
