...
Assert::throws(\RangeException::class, function () use (&$duration, &$smallestUnit) { return $duration->toString((object) JsUndefined::strip(['smallestUnit' => $smallestUnit])); }, "\"{$smallestUnit}\" is not a valid unit for the smallestUnit option");
}
