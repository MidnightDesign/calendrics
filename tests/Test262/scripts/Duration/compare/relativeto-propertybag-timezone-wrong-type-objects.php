...
[$timeZone, $description] = array_pad($__entry__, 2, null);
Assert::throws(\TypeError::class, function () use (&$timeZone) { return \Calendrics\Spec\Duration::compare(new \Calendrics\Spec\Duration(1), new \Calendrics\Spec\Duration(), (object) JsUndefined::strip(['relativeTo' => (object) JsUndefined::strip(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone])])); }, "{$description} is not a valid object and does not convert to a string");
}
