...
Assert::throws(\RangeException::class, function () use (&$duration, &$relativeTo) { return \Calendrics\Spec\Duration::compare($duration, $duration, (object) JsUndefined::strip(['relativeTo' => $relativeTo])); }, '');
}
