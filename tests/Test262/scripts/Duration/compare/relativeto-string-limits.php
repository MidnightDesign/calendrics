...
\Calendrics\Spec\Duration::compare($instance, $blankInstance, JsUndefined::strip(['relativeTo' => $relativeTo]));
}
...
Assert::throws(\RangeException::class, function () use (&$instance, &$blankInstance, &$relativeTo) { return \Calendrics\Spec\Duration::compare($instance, $blankInstance, JsUndefined::strip(['relativeTo' => $relativeTo])); }, "\"{$relativeTo}\" is outside the representable range for a relativeTo parameter");
}
