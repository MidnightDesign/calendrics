...
Assert::throws(\RangeException::class, function () use (&$duration, &$relativeTo) { return \Calendrics\Spec\Duration::compare($duration, $duration, JsUndefined::strip(['relativeTo' => $relativeTo])); }, '');
}
