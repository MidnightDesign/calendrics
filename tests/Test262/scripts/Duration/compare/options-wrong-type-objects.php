...
Assert::throws(\TypeError::class, function () use (&$value) { return \Calendrics\Spec\Duration::compare((object) ['hours' => 1], (object) ['hours' => 1], $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
}
