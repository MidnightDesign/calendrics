...
// Source: tests/Test262/data/Duration/compare/relativeto-string-limits.js
...
\Calendrics\Spec\Duration::compare($instance, $blankInstance, (object) JsUndefined::strip(['relativeTo' => $relativeTo]));
}
...
Assert::throws(\RangeException::class, function () use (&$instance, &$blankInstance, &$relativeTo) { return \Calendrics\Spec\Duration::compare($instance, $blankInstance, (object) JsUndefined::strip(['relativeTo' => $relativeTo])); }, "\"{$relativeTo}\" is outside the representable range for a relativeTo parameter");
}
