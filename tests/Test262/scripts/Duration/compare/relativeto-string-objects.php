...
$instance1 = new \Calendrics\Spec\Duration(0, 0, 0, 31);
$instance2 = new \Calendrics\Spec\Duration(0, 1);
...
$result = \Calendrics\Spec\Duration::compare($instance1, $instance2, (object) JsUndefined::strip(['relativeTo' => $relativeTo]));
