...
$resultWithout = \Calendrics\Spec\Duration::compare($duration1, $duration2, JsUndefined::strip(['relativeTo' => $relativeTo]));
...
$resultWith = \Calendrics\Spec\Duration::compare($duration1, $duration2, JsUndefined::strip(['relativeTo' => $relativeTo]));
