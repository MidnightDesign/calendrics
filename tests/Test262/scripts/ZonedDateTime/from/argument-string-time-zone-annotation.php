...
// Source: tests/Test262/data/ZonedDateTime/from/argument-string-time-zone-annotation.js
...
Assert::sameValue($result->timeZoneId, $expectedZone, "time zone annotation ({$description})");
}
