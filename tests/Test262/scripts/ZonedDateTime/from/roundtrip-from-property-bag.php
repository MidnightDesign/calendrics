...
$dateFromYearMonth = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => $year, 'month' => $month, 'day' => $day, 'hour' => 12, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321, 'timeZone' => 'UTC']), $options);
...
$dateFromYearMonthCode = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => $year, 'monthCode' => $monthCode, 'day' => $day, 'hour' => 12, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321, 'timeZone' => 'UTC']), $options);
