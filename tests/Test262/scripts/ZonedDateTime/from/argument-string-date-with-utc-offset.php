...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\ZonedDateTime::from($arg); }, "\"{$arg}\" UTC offset without time is not valid for ZonedDateTime");
}
