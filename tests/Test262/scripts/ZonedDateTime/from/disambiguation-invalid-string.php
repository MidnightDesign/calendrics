...
Assert::throws(\RangeException::class, function () use (&$datetime) { return \Calendrics\Spec\ZonedDateTime::from($datetime, ['disambiguation' => 'other string']); }, '');
...
Assert::throws(\RangeException::class, function () use (&$propertyBag, &$disambiguation) { return \Calendrics\Spec\ZonedDateTime::from($propertyBag, JsUndefined::strip(['disambiguation' => $disambiguation])); }, '');
}
