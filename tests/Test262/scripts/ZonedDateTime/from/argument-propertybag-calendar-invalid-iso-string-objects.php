...
// Source: tests/Test262/data/ZonedDateTime/from/argument-propertybag-calendar-invalid-iso-string.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\ZonedDateTime::from($arg); }, "{$description} is not a valid calendar ID");
}
