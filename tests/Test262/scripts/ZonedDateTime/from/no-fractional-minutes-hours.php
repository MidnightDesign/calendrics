...
// Source: tests/Test262/data/ZonedDateTime/from/no-fractional-minutes-hours.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\ZonedDateTime::from($arg); }, "{$description} not allowed in time string");
}
