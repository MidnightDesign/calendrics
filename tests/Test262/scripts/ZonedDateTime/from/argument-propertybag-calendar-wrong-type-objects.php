...
// Source: tests/Test262/data/ZonedDateTime/from/argument-propertybag-calendar-wrong-type.js
...
Assert::throws(\TypeError::class, function () use (&$arg) { return \Calendrics\Spec\ZonedDateTime::from($arg); }, "{$description} is not a valid calendar");
}
