...
$explicit = \Calendrics\Spec\ZonedDateTime::from($value, (object) []);
Assert::sameValue($explicit->epochNanoseconds, 1_000_000_000_987_654_321, 'overflow is ignored');
$implicit = \Calendrics\Spec\ZonedDateTime::from($value, (object) []);
...
$propertyBag = (object) ['year' => 2000, 'month' => 15, 'day' => 34, 'hour' => 12, 'timeZone' => 'UTC'];
$explicit = \Calendrics\Spec\ZonedDateTime::from($propertyBag, (object) []);
