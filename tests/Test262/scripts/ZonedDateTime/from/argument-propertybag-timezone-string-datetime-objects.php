...
// Source: tests/Test262/data/ZonedDateTime/from/argument-propertybag-timezone-string-datetime.js
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone])); }, 'bare date-time string is not a time zone');
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone])); }, "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
$timeZone = '2021-08-19T17:30Z';
$result1 = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]));
Assert::sameValue($result1->timeZoneId, 'UTC', 'date-time + Z is UTC time zone');
$timeZone = '2021-08-19T17:30-07:00';
$result2 = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]));
Assert::sameValue($result2->timeZoneId, '-07:00', 'date-time + offset is the offset time zone');
$timeZone = '2021-08-19T17:30[UTC]';
$result3 = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]));
Assert::sameValue($result3->timeZoneId, 'UTC', 'date-time + IANA annotation is the IANA time zone');
$timeZone = '2021-08-19T17:30Z[UTC]';
$result4 = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]));
...
$result5 = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]));
