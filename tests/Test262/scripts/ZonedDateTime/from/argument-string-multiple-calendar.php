...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\ZonedDateTime::from($arg); }, "reject more than one calendar annotation if any critical: {$arg}");
}
