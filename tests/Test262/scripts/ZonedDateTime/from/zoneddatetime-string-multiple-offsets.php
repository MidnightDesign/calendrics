...
$result = \Calendrics\Spec\ZonedDateTime::from($str);
...
Assert::throws(\RangeException::class, function () use (&$str) { return \Calendrics\Spec\ZonedDateTime::from($str); }, 'Trailing zeroes not allowed for sub-minute time zone identifiers');
