...
// Source: tests/Test262/data/ZonedDateTime/from/argument-string-minus-sign.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\ZonedDateTime::from($arg); }, "variant minus sign: {$arg}");
}
