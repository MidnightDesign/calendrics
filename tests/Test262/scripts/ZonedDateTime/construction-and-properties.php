...
$epochMillis = \Calendrics\Tests\Test262\Js::dateUTC(1976, 10, 18, 15, 23, 30, 123);
$epochNanos = 217_178_610_123_456_789;
$zdt = new \Calendrics\Spec\ZonedDateTime($epochNanos, '-08:00');
Assert::assertTrue($zdt instanceof \Calendrics\Spec\ZonedDateTime, '');
Assert::sameValue((is_object($zdt) && !($zdt instanceof \Calendrics\Tests\Test262\JsSymbol)), true, '');
Assert::sameValue($zdt->toInstant()->epochMilliseconds, \Calendrics\Tests\Test262\Js::dateUTC(1976, 10, 18, 15, 23, 30, 123), 'epochMilliseconds');
$zdt = new \Calendrics\Spec\ZonedDateTime($epochNanos, 'UTC');
Assert::assertTrue($zdt instanceof \Calendrics\Spec\ZonedDateTime, '');
Assert::sameValue((is_object($zdt) && !($zdt instanceof \Calendrics\Tests\Test262\JsSymbol)), true, '');
