...
// Source: tests/Test262/data/ZonedDateTime/calendar-invalid-iso-string.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return new \Calendrics\Spec\ZonedDateTime(0, 'UTC', $arg); }, "{$description} is not a valid calendar ID");
}
