...
// Source: tests/Test262/data/ZonedDateTime/prototype/withPlainTime/argument-string-calendar-annotation-invalid-key.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->withPlainTime($arg); }, "annotation keys must be lowercase: {$arg} - {$descr}");
}
