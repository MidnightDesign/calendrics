...
// Source: tests/Test262/data/ZonedDateTime/prototype/withPlainTime/argument-string-calendar-annotation.js
...
Assert::sameValue($result->epochNanoseconds, 45_296_987_654_321, "calendar annotation ({$description})");
}
