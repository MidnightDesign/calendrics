...
// Source: tests/Test262/data/ZonedDateTime/prototype/with/offset-invalid-string.js
...
Assert::throws(\RangeException::class, function () use (&$datetime) { return $datetime->with((object) ['hour' => 2], (object) ['offset' => 'other string']); }, '');
