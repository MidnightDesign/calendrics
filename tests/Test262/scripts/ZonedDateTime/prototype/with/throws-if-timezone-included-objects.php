...
// Source: tests/Test262/data/ZonedDateTime/prototype/with/throws-if-timezone-included.js
...
Assert::throws(\TypeError::class, function () use (&$zdt) { return $zdt->with((object) ['month' => 2, 'timeZone' => 'UTC']); }, '');
