...
// Source: tests/Test262/data/ZonedDateTime/prototype/until/zoneddatetime-string-multiple-offsets.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$str) { return $instance->until($str); }, 'Trailing zeroes not allowed for sub-minute time zone identifiers');
