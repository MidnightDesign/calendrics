...
Assert::throws(\RangeException::class, function () use (&$instance1, &$timeZone) { return $instance1->until((object) JsUndefined::strip(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone])); }, 'bare date-time string is not a time zone');
...
Assert::throws(\RangeException::class, function () use (&$instance1, &$timeZone) { return $instance1->until((object) JsUndefined::strip(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone])); }, "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
