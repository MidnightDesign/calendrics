...
// Source: tests/Test262/data/ZonedDateTime/prototype/until/argument-string-multiple-calendar.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->until($arg); }, "reject more than one calendar annotation if any critical: {$arg}");
}
