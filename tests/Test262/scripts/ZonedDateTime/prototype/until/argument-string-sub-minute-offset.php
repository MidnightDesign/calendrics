...
// Source: tests/Test262/data/ZonedDateTime/prototype/until/argument-string-sub-minute-offset.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$str) { return $instance->until($str); }, "{$str} is not a valid ISO string");
