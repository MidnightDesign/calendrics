...
Assert::assertTrue($zdt->round((object) JsUndefined::strip(['smallestUnit' => $smallestUnit, 'roundingIncrement' => $roundingIncrement])) instanceof \Calendrics\Spec\ZonedDateTime, '');
}
