...
$options = TemporalHelpers::propertyBagObserver($actual, (object) ['smallestUnit' => 'nanoseconds', 'roundingMode' => 'halfExpand', 'roundingIncrement' => 2], 'options');
$nextHourOptions = TemporalHelpers::propertyBagObserver($actual, (object) ['smallestUnit' => 'hour', 'roundingMode' => 'ceil', 'roundingIncrement' => 1], 'options');
$instance = new \Calendrics\Spec\ZonedDateTime(988_786_472_987_654_321, 'UTC');
