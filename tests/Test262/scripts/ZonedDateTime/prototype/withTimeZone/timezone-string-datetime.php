...
// Source: tests/Test262/data/ZonedDateTime/prototype/withTimeZone/timezone-string-datetime.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$timeZone) { return $instance->withTimeZone($timeZone); }, 'bare date-time string is not a time zone');
...
$result5 = $instance->withTimeZone($timeZone);
