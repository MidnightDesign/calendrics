...
// Source: tests/Test262/data/ZonedDateTime/prototype/withTimeZone/timezone-string-sub-minute-offset.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$timeZone) { return $instance->withTimeZone($timeZone); }, "{$timeZone} is not a valid time zone string");
}
