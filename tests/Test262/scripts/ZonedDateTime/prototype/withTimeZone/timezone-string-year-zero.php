...
// Source: tests/Test262/data/ZonedDateTime/prototype/withTimeZone/timezone-string-year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$timeZone) { return $instance->withTimeZone($timeZone); }, 'reject minus zero as extended year');
}
