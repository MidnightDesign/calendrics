...
Assert::throws(\RangeException::class, function () use (&$instance1, &$timeZone) { return $instance1->since(JsUndefined::strip(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone])); }, 'bare date-time string is not a time zone');
...
Assert::throws(\RangeException::class, function () use (&$instance1, &$timeZone) { return $instance1->since(JsUndefined::strip(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone])); }, "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
$timeZone = '2021-08-19T17:30Z';
$instance1->since(JsUndefined::strip(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]));
$expectedTimeZone = '-07:00';
$instance2 = new \Calendrics\Spec\ZonedDateTime(0, $expectedTimeZone);
$timeZone = '2021-08-19T17:30-07:00';
$instance2->since(JsUndefined::strip(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]));
$expectedTimeZone = 'UTC';
$instance3 = new \Calendrics\Spec\ZonedDateTime(0, $expectedTimeZone);
$timeZone = '2021-08-19T17:30[UTC]';
$instance3->since(JsUndefined::strip(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]));
