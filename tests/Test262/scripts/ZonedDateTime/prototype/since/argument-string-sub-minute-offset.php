...
// Source: tests/Test262/data/ZonedDateTime/prototype/since/argument-string-sub-minute-offset.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$str) { return $instance->since($str); }, "{$str} is not a valid ISO string");
