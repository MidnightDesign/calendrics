...
// Source: tests/Test262/data/ZonedDateTime/prototype/since/argument-propertybag-calendar-invalid-iso-string.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->since($arg); }, "{$description} is not a valid calendar ID");
}
