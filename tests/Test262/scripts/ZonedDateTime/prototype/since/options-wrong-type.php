...
// Source: tests/Test262/data/ZonedDateTime/prototype/since/options-wrong-type.js
...
Assert::throws(\TypeError::class, function () use (&$instance, &$value) { return $instance->since(new \Calendrics\Spec\ZonedDateTime(3_600_000_000_000, 'UTC'), $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
}
