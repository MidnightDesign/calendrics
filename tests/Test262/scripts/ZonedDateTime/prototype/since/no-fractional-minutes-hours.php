...
// Source: tests/Test262/data/ZonedDateTime/prototype/since/no-fractional-minutes-hours.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->since($arg); }, "{$description} not allowed in time string");
}
