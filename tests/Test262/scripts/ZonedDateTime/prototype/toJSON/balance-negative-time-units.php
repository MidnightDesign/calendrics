...
// Source: tests/Test262/data/ZonedDateTime/prototype/toJSON/balance-negative-time-units.js
...
$datetime = new \Calendrics\Spec\ZonedDateTime(1001, '-00:02');
$jsonString = $datetime->toJSON();
