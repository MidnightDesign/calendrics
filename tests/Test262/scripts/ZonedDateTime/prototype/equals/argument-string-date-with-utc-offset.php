...
// Source: tests/Test262/data/ZonedDateTime/prototype/equals/argument-string-date-with-utc-offset.js
...
Assert::sameValue($result, true, "\"{$arg}\" is a valid UTC offset with time for ZonedDateTime");
}
$invalidStrings = ['2022-09-15Z[UTC]', '2022-09-15Z[Europe/Vienna]', '2022-09-15+00:00[UTC]', '2022-09-15-02:30[America/St_Johns]'];
foreach ($invalidStrings as $arg) {
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->equals($arg); }, "\"{$arg}\" UTC offset without time is not valid for ZonedDateTime");
}
