...
// Source: tests/Test262/data/ZonedDateTime/prototype/epochMilliseconds/prop-desc.js
...
Assert::readOnlyAccessor(\Calendrics\Spec\ZonedDateTime::class, 'epochMilliseconds');
