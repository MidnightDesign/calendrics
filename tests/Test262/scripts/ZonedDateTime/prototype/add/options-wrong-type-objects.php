...
// Source: tests/Test262/data/ZonedDateTime/prototype/add/options-wrong-type.js
...
Assert::throws(\TypeError::class, function () use (&$instance, &$value) { return $instance->add((object) ['years' => 1], $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
}
