...
// Source: tests/Test262/data/ZonedDateTime/prototype/add/options-object.js
...
$result1 = $instance->add((object) ['years' => 1], (object) []);
Assert::sameValue($result1->epochNanoseconds, 31_536_000_000_000_000, 'UTC');
$result2 = $instance->add((object) ['years' => 1], function () {  });
