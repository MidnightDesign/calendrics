...
// Source: tests/Test262/data/PlainDate/prototype/toPlainDateTime/argument-string-date-with-utc-offset.js
...
TemporalHelpers::assertPlainDateTime($result, 2000, 5, 'M05', 2, 12, 34, 56, 987, 654, 321, "\"{$arg}\" is a valid UTC offset with time for PlainTime");
}
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->toPlainDateTime($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainTime");
}
