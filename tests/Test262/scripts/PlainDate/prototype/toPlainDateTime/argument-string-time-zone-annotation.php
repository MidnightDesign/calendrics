...
// Source: tests/Test262/data/PlainDate/prototype/toPlainDateTime/argument-string-time-zone-annotation.js
...
TemporalHelpers::assertPlainDateTime($result, 2000, 5, 'M05', 2, 12, 34, 56, 987, 654, 321, "time zone annotation ({$description})");
}
