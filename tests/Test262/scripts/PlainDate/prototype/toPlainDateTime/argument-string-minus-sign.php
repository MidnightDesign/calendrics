...
// Source: tests/Test262/data/PlainDate/prototype/toPlainDateTime/argument-string-minus-sign.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->toPlainDateTime($arg); }, "variant minus sign: {$arg}");
}
