...
// Source: tests/Test262/data/PlainDate/prototype/toPlainDateTime/argument-propertybag-optional-properties.js
...
$resultWithout = $instance->toPlainDateTime($minimumProperties);
$resultWith = $instance->toPlainDateTime($allProperties);
