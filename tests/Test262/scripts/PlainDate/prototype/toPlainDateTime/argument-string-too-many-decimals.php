...
// Source: tests/Test262/data/PlainDate/prototype/toPlainDateTime/argument-string-too-many-decimals.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { $instance->toPlainDateTime($arg); }, 'no more than 9 decimal places are allowed');
}
