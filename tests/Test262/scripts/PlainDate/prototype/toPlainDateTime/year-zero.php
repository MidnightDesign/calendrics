...
// Source: tests/Test262/data/PlainDate/prototype/toPlainDateTime/year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->toPlainDateTime($arg); }, 'reject minus zero as extended year');
}
