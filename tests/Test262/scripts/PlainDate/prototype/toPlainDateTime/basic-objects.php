...
$optionBag = $date->toPlainDateTime((object) ['hour' => 11, 'minute' => 30, 'second' => 23]);
...
$plainTime = $date->toPlainDateTime(\Calendrics\Spec\PlainTime::from('11:30:23'));
...
$plainDateTime = $date->toPlainDateTime(\Calendrics\Spec\PlainDateTime::from('1999-07-14T11:30:23'));
...
$zonedDateTime = $date->toPlainDateTime(\Calendrics\Spec\ZonedDateTime::from('1999-07-14T11:30:23Z[UTC]'));
