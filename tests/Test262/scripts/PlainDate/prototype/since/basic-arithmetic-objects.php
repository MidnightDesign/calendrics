...
// Source: tests/Test262/data/PlainDate/prototype/since/basic-arithmetic.js
...
TemporalHelpers::assertDuration($one->since($two, (object) JsUndefined::strip(['largestUnit' => $largestUnit])), $neg($years), $neg($months), $neg($weeks), $neg($days), 0, 0, 0, 0, 0, 0, $descr);
}
}
