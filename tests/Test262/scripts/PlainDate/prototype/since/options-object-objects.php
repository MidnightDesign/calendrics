...
// Source: tests/Test262/data/PlainDate/prototype/since/options-object.js
...
$result1 = $instance->since(new \Calendrics\Spec\PlainDate(1976, 11, 18), (object) []);
TemporalHelpers::assertDuration($result1, 0, 0, 0, 8566, 0, 0, 0, 0, 0, 0, 'options may be an empty plain object');
$result2 = $instance->since(new \Calendrics\Spec\PlainDate(1976, 11, 18), function () {  });
