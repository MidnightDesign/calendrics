...
// Source: tests/Test262/data/PlainDate/prototype/equals/argument-leap-second.js
...
$instance = new \Calendrics\Spec\PlainDate(2016, 12, 31);
...
Assert::sameValue($result2, true, 'second: 60 is ignored in property bag for PlainDate');
