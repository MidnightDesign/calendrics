...
TemporalHelpers::assertPlainDate($date->subtract((object) ['months' => 11]), 2018, 12, 'M12', 18);
TemporalHelpers::assertPlainDate($date->subtract((object) ['days' => 20]), 2019, 10, 'M10', 29);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('2019-02-28')->subtract((object) ['months' => 1]), 2019, 1, 'M01', 28);
TemporalHelpers::assertPlainDate($date->subtract(\Calendrics\Spec\Duration::from('P43Y')), 1976, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('1976-11-18')->subtract((object) JsUndefined::strip(['years' => -43])), 2019, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('2018-12-18')->subtract((object) JsUndefined::strip(['months' => -11])), 2019, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('2019-10-29')->subtract((object) JsUndefined::strip(['days' => -20])), 2019, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('2019-01-28')->subtract((object) JsUndefined::strip(['months' => -1])), 2019, 2, 'M02', 28);
