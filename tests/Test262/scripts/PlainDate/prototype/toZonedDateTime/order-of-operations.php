...
$instance = new \Calendrics\Spec\PlainDate(2000, 1, 1, 'iso8601');
$plainTime = TemporalHelpers::propertyBagObserver($actual, ['hour' => 2, 'minute' => 30, 'second' => 0, 'millisecond' => 0, 'microsecond' => 0, 'nanosecond' => 0], 'item.plainTime');
$item = TemporalHelpers::propertyBagObserver($actual, JsUndefined::strip(['plainTime' => $plainTime, 'timeZone' => 'UTC']), 'item', ['timeZone']);
