...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { $instance->toZonedDateTime(JsUndefined::strip(['plainTime' => $arg, 'timeZone' => 'UTC'])); }, 'no more than 9 decimal places are allowed');
}
