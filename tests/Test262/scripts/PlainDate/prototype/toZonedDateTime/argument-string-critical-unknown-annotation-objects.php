...
// Source: tests/Test262/data/PlainDate/prototype/toZonedDateTime/argument-string-critical-unknown-annotation.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->toZonedDateTime((object) JsUndefined::strip(['plainTime' => $arg, 'timeZone' => 'UTC'])); }, "reject unknown annotation with critical flag: {$arg}");
}
