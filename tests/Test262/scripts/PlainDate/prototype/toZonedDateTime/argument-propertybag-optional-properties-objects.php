...
$resultWithout = $instance->toZonedDateTime((object) JsUndefined::strip(['plainTime' => $minimumProperties, 'timeZone' => 'UTC']));
$resultWith = $instance->toZonedDateTime((object) JsUndefined::strip(['plainTime' => $allProperties, 'timeZone' => 'UTC']));
