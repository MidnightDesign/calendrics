...
// Source: tests/Test262/data/PlainDate/prototype/toZonedDateTime/argument-string-multiple-calendar.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->toZonedDateTime((object) JsUndefined::strip(['plainTime' => $arg, 'timeZone' => 'UTC'])); }, "reject more than one calendar annotation if any critical: {$arg}");
}
