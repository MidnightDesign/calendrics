...
// Source: tests/Test262/data/PlainDate/prototype/toZonedDateTime/year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->toZonedDateTime((object) JsUndefined::strip(['plainTime' => $arg, 'timeZone' => 'UTC'])); }, 'reject minus zero as extended year');
}
