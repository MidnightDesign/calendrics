...
// Source: tests/Test262/data/PlainDate/prototype/toZonedDateTime/argument-string-too-many-decimals.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { $instance->toZonedDateTime((object) JsUndefined::strip(['plainTime' => $arg, 'timeZone' => 'UTC'])); }, 'no more than 9 decimal places are allowed');
}
