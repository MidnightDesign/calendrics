...
// Source: tests/Test262/data/PlainDate/prototype/toZonedDateTime/argument-string-date-with-utc-offset.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->toZonedDateTime((object) JsUndefined::strip(['plainTime' => $arg, 'timeZone' => 'UTC'])); }, "\"{$arg}\" UTC offset without time is not valid for PlainTime");
}
