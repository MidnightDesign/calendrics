...
TemporalHelpers::assertPlainDate($date->add((object) ['months' => 3]), 1977, 2, 'M02', 18);
TemporalHelpers::assertPlainDate($date->add((object) ['days' => 20]), 1976, 12, 'M12', 8);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('2019-01-31')->add((object) ['months' => 1]), 2019, 2, 'M02', 28);
TemporalHelpers::assertPlainDate($date->add(\Calendrics\Spec\Duration::from('P43Y')), 2019, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('2019-11-18')->add((object) JsUndefined::strip(['years' => -43])), 1976, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('1977-02-18')->add((object) JsUndefined::strip(['months' => -3])), 1976, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('1976-12-08')->add((object) JsUndefined::strip(['days' => -20])), 1976, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Calendrics\Spec\PlainDate::from('2019-02-28')->add((object) JsUndefined::strip(['months' => -1])), 2019, 1, 'M01', 28);
