...
// Source: tests/Test262/data/PlainDate/prototype/until/argument-string-limits.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->until($arg); }, "\"{$arg}\" is outside the representable range of PlainDate");
}
