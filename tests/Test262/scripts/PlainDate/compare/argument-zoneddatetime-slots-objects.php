...
// Source: tests/Test262/data/PlainDate/compare/argument-zoneddatetime-slots.js
...
$arg = new \Calendrics\Spec\ZonedDateTime(0, 'UTC');
\Calendrics\Spec\PlainDate::compare($arg, new \Calendrics\Spec\PlainDate(1976, 11, 18));
\Calendrics\Spec\PlainDate::compare(new \Calendrics\Spec\PlainDate(1976, 11, 18), $arg);
