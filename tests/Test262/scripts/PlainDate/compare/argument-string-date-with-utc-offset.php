...
// Source: tests/Test262/data/PlainDate/compare/argument-string-date-with-utc-offset.js
...
$result = \Calendrics\Spec\PlainDate::compare($arg, $arg);
Assert::sameValue($result, 0, "\"{$arg}\" is a valid UTC offset with time for PlainDate");
}
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::compare($arg, new \Calendrics\Spec\PlainDate(1976, 11, 18)); }, "\"{$arg}\" UTC offset without time is not valid for PlainDate (first argument)");
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::compare(new \Calendrics\Spec\PlainDate(1976, 11, 18), $arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainDate (second argument)");
}
