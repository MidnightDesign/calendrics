...
$dateFromYearMonth = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => $date->year, 'month' => $date->month, 'day' => $date->day]));
...
$dateFromYearMonthCode = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => $date->year, 'monthCode' => $date->monthCode, 'day' => $date->day]));
...
$year2000 = new \Calendrics\Spec\PlainDate(2000, 1, 1);
$testRoundtrip($year2000);
$year1 = new \Calendrics\Spec\PlainDate(1, 1, 1);
$testRoundtrip($year1);
