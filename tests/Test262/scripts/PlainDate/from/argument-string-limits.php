...
\Calendrics\Spec\PlainDate::from($arg);
}
$invalidStrings = ['-271821-04-18', '-271821-04-18T23:00', '+275760-09-14', '+275760-09-14T01:00'];
foreach ($invalidStrings as $arg) {
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::from($arg); }, "\"{$arg}\" is outside the representable range of PlainDate");
}
