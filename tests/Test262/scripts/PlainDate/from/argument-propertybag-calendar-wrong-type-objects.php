...
// Source: tests/Test262/data/PlainDate/from/argument-propertybag-calendar-wrong-type.js
...
Assert::throws(\TypeError::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::from($arg); }, "{$description} is not a valid calendar");
}
