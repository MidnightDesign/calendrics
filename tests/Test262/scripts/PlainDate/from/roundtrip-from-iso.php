...
$dateFromYearMonth = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['year' => $date->year, 'month' => $date->month, 'day' => $date->day]));
...
$dateFromYearMonthCode = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['year' => $date->year, 'monthCode' => $date->monthCode, 'day' => $date->day]));
