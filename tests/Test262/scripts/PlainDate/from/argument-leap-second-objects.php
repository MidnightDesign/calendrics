...
$result1 = \Calendrics\Spec\PlainDate::from($arg);
TemporalHelpers::assertPlainDate($result1, 2016, 12, 'M12', 31, 'leap second is a valid ISO string for PlainDate');
$result2 = \Calendrics\Spec\PlainDate::from($arg, (object) ['overflow' => 'reject']);
...
$result3 = \Calendrics\Spec\PlainDate::from($arg);
TemporalHelpers::assertPlainDate($result3, 2016, 12, 'M12', 31, 'second: 60 is ignored in property bag for PlainDate');
$result4 = \Calendrics\Spec\PlainDate::from($arg, (object) ['overflow' => 'reject']);
