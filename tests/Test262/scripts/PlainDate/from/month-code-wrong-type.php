...
Assert::throws(\TypeError::class, function () use (&$year, &$monthCode) { return \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['year' => $year, 'monthCode' => $monthCode, 'day' => 1])); }, ($monthCode instanceof \Calendrics\Tests\Test262\JsSymbol ? 'Symbol should be rejected as month code' : "month code {$monthCode} should be rejected"));
}
