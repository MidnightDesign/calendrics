...
// Source: tests/Test262/data/PlainDate/from/argument-string-multiple-calendar.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::from($arg); }, "reject more than one calendar annotation if any critical: {$arg}");
}
