...
// Source: tests/Test262/data/PlainDate/from/argument-string-multiple-time-zone.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::from($arg); }, "reject more than one time zone annotation: {$arg}");
}
