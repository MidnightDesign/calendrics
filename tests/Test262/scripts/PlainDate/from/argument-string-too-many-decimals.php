...
// Source: tests/Test262/data/PlainDate/from/argument-string-too-many-decimals.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { \Calendrics\Spec\PlainDate::from($arg); }, 'no more than 9 decimal places are allowed');
}
