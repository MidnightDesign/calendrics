...
// Source: tests/Test262/data/PlainDate/from/argument-string-minus-sign.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::from($arg); }, "variant minus sign: {$arg}");
}
