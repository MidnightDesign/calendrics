...
// Source: tests/Test262/data/PlainDate/from/argument-propertybag-calendar-year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::from($arg); }, 'reject minus zero as extended year');
}
