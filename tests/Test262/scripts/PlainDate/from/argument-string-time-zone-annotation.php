...
// Source: tests/Test262/data/PlainDate/from/argument-string-time-zone-annotation.js
...
$result = \Calendrics\Spec\PlainDate::from($arg);
TemporalHelpers::assertPlainDate($result, 2000, 5, 'M05', 2, "time zone annotation ({$description})");
}
