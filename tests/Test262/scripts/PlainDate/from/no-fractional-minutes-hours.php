...
// Source: tests/Test262/data/PlainDate/from/no-fractional-minutes-hours.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDate::from($arg); }, "{$description} not allowed in time string");
}
