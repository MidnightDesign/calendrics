...
// Source: tests/Test262/data/PlainDate/from/argument-string-unknown-annotation.js
...
TemporalHelpers::assertPlainDate($result, 2000, 5, 'M05', 2, "unknown annotation ({$description})");
}
