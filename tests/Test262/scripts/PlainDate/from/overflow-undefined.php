...
$explicit = \Calendrics\Spec\PlainDate::from($value, []);
TemporalHelpers::assertPlainDate($explicit, 2000, 5, 'M05', 2, 'overflow is ignored');
$implicit = \Calendrics\Spec\PlainDate::from($value, []);
...
$explicit = \Calendrics\Spec\PlainDate::from($propertyBag, []);
TemporalHelpers::assertPlainDate($explicit, 2000, 12, 'M12', 31, 'default overflow is constrain');
$implicit = \Calendrics\Spec\PlainDate::from($propertyBag, []);
