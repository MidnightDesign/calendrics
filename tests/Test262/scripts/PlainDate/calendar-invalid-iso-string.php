...
// Source: tests/Test262/data/PlainDate/calendar-invalid-iso-string.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return new \Calendrics\Spec\PlainDate(2000, 5, 2, $arg); }, "{$description} is not a valid calendar ID");
}
