...
$fall = \Calendrics\Spec\ZonedDateTime::from(['year' => 2018, 'month' => 2, 'day' => 17, 'hour' => 12, 'timeZone' => 'America/Sao_Paulo']);
Assert::sameValue($fall->hoursInDay, 25, '25-hour day with backward jump at midnight');
$spring = \Calendrics\Spec\ZonedDateTime::from(['year' => 2018, 'month' => 11, 'day' => 4, 'hour' => 12, 'timeZone' => 'America/Sao_Paulo']);
