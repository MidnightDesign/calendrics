...
$instance = \Calendrics\Spec\ZonedDateTime::from((object) ['year' => 1919, 'month' => 3, 'day' => 31, 'hour' => 12, 'timeZone' => 'America/Toronto']);
$startOfDay = $instance->withPlainTime();
$midnightDisambiguated = $instance->withPlainTime(new \Calendrics\Spec\PlainTime());
