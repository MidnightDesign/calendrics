...
$instance = new \Calendrics\Spec\ZonedDateTime(1_000_000_000_000_000_000, 'UTC', 'hebrew');
$resultYear = $instance->with((object) ['year' => 5762]);
...
$resultMonth = $instance->with((object) ['month' => 11]);
...
$resultMonthCode = $instance->with((object) ['monthCode' => 'M11']);
