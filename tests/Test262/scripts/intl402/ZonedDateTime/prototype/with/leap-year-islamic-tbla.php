...
$leapDay = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 1445, 'monthCode' => 'M12', 'day' => 30, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
...
Assert::throws(\RangeException::class, function () use (&$leapDay, &$options) { $leapDay->with(['year' => 1444], $options); }, 'reject when moving to a common year');
