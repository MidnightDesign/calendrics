...
TemporalHelpers::assertPlainDateTime($common0231->with((object) JsUndefined::strip(['monthCode' => $monthCode]), $options)->toPlainDateTime(), 1944, $month, $monthCode, 31, 12, 34, 0, 0, 0, 0, "common-year {$monthCode} does not reject 31 when adding", 'shaka', 1944);
}
...
[$month, $monthCode] = array_pad($__entry__, 2, null);
TemporalHelpers::assertPlainDateTime($leap0131->with((object) JsUndefined::strip(['monthCode' => $monthCode]), $options)->toPlainDateTime(), 1946, $month, $monthCode, 31, 12, 34, 0, 0, 0, 0, "leap-year {$monthCode} does not reject 31 when adding", 'shaka', 1946);
}
