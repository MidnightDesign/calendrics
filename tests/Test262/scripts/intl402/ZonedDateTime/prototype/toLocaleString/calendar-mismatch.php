...
$sameCalendarInstance = new \Calendrics\Spec\ZonedDateTime(0, 'UTC', $localeCalendar);
...
$isoInstance = new \Calendrics\Spec\ZonedDateTime(0, 'UTC', 'iso8601');
...
$differentCalendarInstance = new \Calendrics\Spec\ZonedDateTime(0, 'UTC', $differentCalendar);
