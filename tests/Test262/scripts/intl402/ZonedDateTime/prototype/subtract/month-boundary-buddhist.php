...
$date255512 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 2555, 'monthCode' => 'M12', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$dates = [$date255512];
