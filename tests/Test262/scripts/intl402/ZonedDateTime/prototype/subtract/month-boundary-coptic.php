...
$date17161201 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 1716, 'monthCode' => 'M12', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$dates = [$date17161201];
