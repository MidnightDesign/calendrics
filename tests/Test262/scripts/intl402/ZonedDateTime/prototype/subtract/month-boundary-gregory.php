...
$date20001201 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 2000, 'monthCode' => 'M12', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$dates = [$date20001201];
