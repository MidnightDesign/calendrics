...
// Source: tests/Test262/data/intl402/ZonedDateTime/prototype/dayOfYear/non-iso-calendar-basic.js
...
$days1 = new \Calendrics\Spec\Duration(0, 0, 0, 1);
foreach ($sampleYears as $calendar => $year) {
$date = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => $year, 'month' => 1, 'day' => 1, 'calendar' => $calendar, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC']));
$expectedDay = 1;
