...
$bce5 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['era' => 'bce', 'eraYear' => 5, 'monthCode' => 'M06', 'day' => 15, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$bce2 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['era' => 'bce', 'eraYear' => 2, 'monthCode' => 'M12', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$bce1 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['era' => 'bce', 'eraYear' => 1, 'monthCode' => 'M06', 'day' => 15, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$ce1 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['era' => 'ce', 'eraYear' => 1, 'monthCode' => 'M06', 'day' => 15, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$ce2 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['era' => 'ce', 'eraYear' => 2, 'monthCode' => 'M01', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$ce5 = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['era' => 'ce', 'eraYear' => 5, 'monthCode' => 'M06', 'day' => 15, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
