...
// Source: tests/Test262/data/intl402/ZonedDateTime/prototype/since/leap-months-hebrew.js
...
$common1Shevat = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 5783, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
...
$common1Nisan = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 5783, 'monthCode' => 'M07', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$leapShevat = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$leapAdarI = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05L', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$leapAdarII = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M06', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$common2Shevat = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 5785, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
