...
// Source: tests/Test262/data/intl402/ZonedDateTime/prototype/since/dst-month-day-boundary.js
...
$d1 = new \Calendrics\Spec\ZonedDateTime(957_258_000_000_000_000, 'America/Vancouver');
$d2 = new \Calendrics\Spec\ZonedDateTime(954_669_600_000_000_000, 'America/Vancouver');
$result = $d1->since($d2, (object) ['largestUnit' => 'months']);
