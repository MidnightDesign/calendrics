...
$zdt1 = \Calendrics\Spec\ZonedDateTime::from('2010-03-04T23:10:00+11:00[Antarctica/Casey]');
$zdt2 = \Calendrics\Spec\ZonedDateTime::from('2010-03-05T00:45:00+11:00[Antarctica/Casey]');
$zdt3 = \Calendrics\Spec\ZonedDateTime::from('2010-03-04T23:10:00+08:00[Antarctica/Casey]');
$zdt4 = \Calendrics\Spec\ZonedDateTime::from('2010-03-05T00:45:00+08:00[Antarctica/Casey]');
...
$startOfMarch6 = \Calendrics\Spec\ZonedDateTime::from('2010-03-06T00:00:00+08:00[Antarctica/Casey]');
foreach (['floor', 'trunc'] as $roundingMode) {
$options = JsUndefined::strip(['smallestUnit' => 'days', 'roundingMode' => $roundingMode]);
