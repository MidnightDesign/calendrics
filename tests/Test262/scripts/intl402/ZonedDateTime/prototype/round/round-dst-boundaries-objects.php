...
// Source: tests/Test262/data/intl402/ZonedDateTime/prototype/round/round-dst-boundaries.js
...
$roundTo = (object) ['smallestUnit' => 'day'];
$roundMeDown = \Calendrics\Spec\PlainDateTime::from('2000-10-29T11:29:59')->toZonedDateTime('America/Vancouver');
Assert::sameValue("" . ($roundMeDown->round($roundTo)) . "", '2000-10-29T00:00:00-07:00[America/Vancouver]', '');
$roundMeUp = \Calendrics\Spec\PlainDateTime::from('2000-10-29T11:30:01')->toZonedDateTime('America/Vancouver');
Assert::sameValue("" . ($roundMeUp->round($roundTo)) . "", '2000-10-30T00:00:00-08:00[America/Vancouver]', '');
$roundTo = (object) ['smallestUnit' => 'day'];
$roundMeDown = \Calendrics\Spec\PlainDateTime::from('2000-04-02T12:29:59')->toZonedDateTime('America/Vancouver');
Assert::sameValue("" . ($roundMeDown->round($roundTo)) . "", '2000-04-02T00:00:00-08:00[America/Vancouver]', '');
$roundMeUp = \Calendrics\Spec\PlainDateTime::from('2000-04-02T12:30:01')->toZonedDateTime('America/Vancouver');
