...
$overflowFields = (object) ['year' => 2000, 'month' => 13, 'day' => 2, 'timeZone' => 'UTC'];
$overflowExplicit = \Calendrics\Spec\ZonedDateTime::from($overflowFields);
Assert::sameValue($overflowExplicit->month, 12, 'default overflow is constrain');
$overflowPropertyImplicit = \Calendrics\Spec\ZonedDateTime::from($overflowFields, (object) []);
Assert::sameValue($overflowPropertyImplicit->month, 12, 'default overflow is constrain');
$overflowImplicit = \Calendrics\Spec\ZonedDateTime::from($overflowFields);
Assert::sameValue($overflowImplicit->month, 12, 'default overflow is constrain');
$timeZone = 'America/Vancouver';
$disambiguationEarlierFields = (object) JsUndefined::strip(['timeZone' => $timeZone, 'year' => 2000, 'month' => 10, 'day' => 29, 'hour' => 1, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321]);
$disambiguationLaterFields = (object) JsUndefined::strip(['timeZone' => $timeZone, 'year' => 2000, 'month' => 4, 'day' => 2, 'hour' => 2, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321]);
...
$propertyImplicit = \Calendrics\Spec\ZonedDateTime::from($fields, (object) []);
...
$offsetFields = (object) ['year' => 2000, 'month' => 5, 'day' => 2, 'offset' => '+23:59', 'timeZone' => 'UTC'];
...
Assert::throws(\RangeException::class, function () use (&$offsetFields) { return \Calendrics\Spec\ZonedDateTime::from($offsetFields, (object) []); }, 'default offset is reject');
Assert::throws(\RangeException::class, function () use (&$offsetFields) { return \Calendrics\Spec\ZonedDateTime::from($offsetFields); }, 'default offset is reject');
