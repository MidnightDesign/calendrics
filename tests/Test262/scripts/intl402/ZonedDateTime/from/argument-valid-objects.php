...
$result = \Calendrics\Spec\ZonedDateTime::from((object) JsUndefined::strip(['year' => 1970, 'month' => 1, 'day' => 1, 'timeZone' => $valid]));
Assert::assertTrue($result instanceof \Calendrics\Spec\ZonedDateTime, '');
