...
$calendar = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['calendar' => $calendarEraAlias['calendar'], 'era' => $calendarEraAlias['alias'], 'eraYear' => 1, 'month' => 1, 'day' => 1, 'timeZone' => 'UTC']));
