...
$date = \Calendrics\Spec\ZonedDateTime::from(JsUndefined::strip(['era' => $era, 'eraYear' => $eraYear, 'monthCode' => 'M01', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
