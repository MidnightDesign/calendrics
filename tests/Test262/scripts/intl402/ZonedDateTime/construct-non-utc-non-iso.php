...
$instance = new \Calendrics\Spec\ZonedDateTime($epochNanos, 'Europe/Vienna', 'gregory');
Assert::assertTrue($instance instanceof \Calendrics\Spec\ZonedDateTime, 'instanceof is correct');
Assert::sameValue((is_object($instance) && !($instance instanceof \Calendrics\Tests\Test262\JsSymbol)), true, 'typeof is correct');
