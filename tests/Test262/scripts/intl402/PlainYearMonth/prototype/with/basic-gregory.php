...
$calendar = 'gregory';
$cases = JsUndefined::strip(['year2000' => JsUndefined::strip(['era' => 'ce', 'eraYear' => 2000, 'month' => 1, 'monthCode' => 'M01', 'calendar' => $calendar]), 'year1' => JsUndefined::strip(['era' => 'ce', 'eraYear' => 1, 'month' => 1, 'monthCode' => 'M01', 'calendar' => $calendar])]);
