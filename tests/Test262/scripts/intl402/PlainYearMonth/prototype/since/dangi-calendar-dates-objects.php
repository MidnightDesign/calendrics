...
// Source: tests/Test262/data/intl402/PlainYearMonth/prototype/since/dangi-calendar-dates.js
...
$start = \Calendrics\Spec\PlainYearMonth::from((object) JsUndefined::strip(array_merge((array) $startDate, ['calendar' => $calendar])));
