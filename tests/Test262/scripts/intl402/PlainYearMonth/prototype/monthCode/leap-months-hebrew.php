...
// Source: tests/Test262/data/intl402/PlainYearMonth/prototype/monthCode/leap-months-hebrew.js
...
$monthsInYear = \Calendrics\Spec\PlainYearMonth::from(JsUndefined::strip(['year' => $year, 'month' => 1, 'calendar' => $calendar]))->monthsInYear;
