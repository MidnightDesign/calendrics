...
// Source: tests/Test262/data/intl402/PlainYearMonth/prototype/until/dangi-calendar-dates.js
...
$start = \Calendrics\Spec\PlainYearMonth::from(JsUndefined::strip(array_merge($startDate, ['calendar' => $calendar])));
