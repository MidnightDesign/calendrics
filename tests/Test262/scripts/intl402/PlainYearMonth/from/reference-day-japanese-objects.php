...
// Source: tests/Test262/data/intl402/PlainYearMonth/from/reference-day-japanese.js
...
$result1 = \Calendrics\Spec\PlainYearMonth::from((object) ['calendar' => 'japanese', 'era' => 'heisei', 'eraYear' => 1, 'month' => 1]);
...
$result2 = \Calendrics\Spec\PlainYearMonth::from((object) ['calendar' => 'japanese', 'era' => 'showa', 'eraYear' => 1, 'month' => 12]);
...
$result3 = \Calendrics\Spec\PlainYearMonth::from((object) ['calendar' => 'japanese', 'era' => 'taisho', 'eraYear' => 1, 'month' => 7]);
