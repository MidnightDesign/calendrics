...
$result = \Calendrics\Spec\PlainYearMonth::from($fields, ['overflow' => 'constrain']);
...
Assert::throws(\RangeException::class, function () use (&$fields) { return \Calendrics\Spec\PlainYearMonth::from($fields, ['overflow' => 'reject']); }, "Chinese intercalary month {$leapMonthCode} does not exist in year 2022 (overflow reject)");
}
...
$result = \Calendrics\Spec\PlainYearMonth::from(JsUndefined::strip(['year' => $year, 'monthCode' => $monthCode, 'calendar' => 'chinese']));
