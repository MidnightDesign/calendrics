...
Assert::throws(\RangeException::class, function () use (&$instance, &$relativeTo) { return $instance->round(JsUndefined::strip(['largestUnit' => 'years', 'relativeTo' => $relativeTo])); }, 'date-time + offset + IANA annotation throws if wall time and exact time mismatch');
