...
Assert::throws(\RangeException::class, function () use (&$instance, &$relativeTo) { return $instance->total((object) JsUndefined::strip(['unit' => 'days', 'relativeTo' => $relativeTo])); }, 'date-time + offset + IANA annotation throws if wall time and exact time mismatch');
