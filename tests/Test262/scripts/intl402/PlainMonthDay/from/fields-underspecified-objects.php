...
Assert::throws(\TypeError::class, function () use (&$arg, &$calendarId) { return \Calendrics\Spec\PlainMonthDay::from((object) JsUndefined::strip(array_merge((is_object($arg) ? (array) $arg : $arg), ['calendar' => $calendarId]))); }, $description);
}
