...
// Source: tests/Test262/data/intl402/PlainMonthDay/from/chinese-leap-month-codes-common.js
...
if (!$has30) {
$regularMonth = \Calendrics\Tests\Test262\Js::slice($monthCode, 0, 3);
$constrain30 = \Calendrics\Spec\PlainMonthDay::from((object) JsUndefined::strip(['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 30]));
...
$constrain31 = \Calendrics\Spec\PlainMonthDay::from((object) JsUndefined::strip(['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 31]));
...
Assert::throws(\RangeException::class, function () use (&$calendar, &$monthCode) { \Calendrics\Spec\PlainMonthDay::from((object) JsUndefined::strip(['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 30]), (object) ['overflow' => 'reject']); }, "{$monthCode}-30 should throw with reject");
}
