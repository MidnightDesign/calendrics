...
$constrain = \Calendrics\Spec\PlainMonthDay::from(JsUndefined::strip(['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => $day + 1]), ['overflow' => 'constrain']);
...
Assert::throws(\RangeException::class, function () use (&$calendar, &$monthCode, &$day) { \Calendrics\Spec\PlainMonthDay::from(JsUndefined::strip(['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => $day + 1]), ['overflow' => 'reject']); }, '');
}
