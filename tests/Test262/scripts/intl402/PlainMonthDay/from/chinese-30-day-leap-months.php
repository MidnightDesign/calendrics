...
$pmd = \Calendrics\Spec\PlainMonthDay::from(JsUndefined::strip(['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 30]));
TemporalHelpers::assertPlainMonthDay($pmd, $monthCode, 30, "{$monthCode}-30", $referenceYear);
$constrain = \Calendrics\Spec\PlainMonthDay::from(JsUndefined::strip(['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 31]));
...
Assert::throws(\RangeException::class, function () use (&$calendar, &$monthCode) { \Calendrics\Spec\PlainMonthDay::from(JsUndefined::strip(['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 31]), ['overflow' => 'reject']); }, '');
}
