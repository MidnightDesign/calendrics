...
$sameCalendarInstance = \Calendrics\Spec\PlainMonthDay::from((object) JsUndefined::strip(['monthCode' => 'M01', 'day' => 1, 'calendar' => $localeCalendar]));
...
$differentCalendarInstance = \Calendrics\Spec\PlainMonthDay::from((object) JsUndefined::strip(['monthCode' => 'M01', 'day' => 1, 'calendar' => $differentCalendar]));
...
$isoInstance = \Calendrics\Spec\PlainMonthDay::from((object) ['monthCode' => 'M01', 'day' => 1, 'calendar' => 'iso8601']);
