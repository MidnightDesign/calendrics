...
// Source: tests/Test262/data/intl402/PlainDate/future-calendar.js
...
Assert::throws(\RangeException::class, function () use (&$calendar) { new \Calendrics\Spec\PlainDate(1970, 1, 1, $calendar); }, "{$calendar} is not yet supported");
}
