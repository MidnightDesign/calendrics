...
$startOfMonth = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => $commonYear, 'month' => $month, 'day' => 1, 'calendar' => $calendar]), $options);
...
$endOfMonth = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => $commonYear, 'month' => $month, 'day' => $day, 'calendar' => $calendar]), $options);
