...
Assert::throws(\RangeException::class, function () use (&$calendar) { return \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['month' => 1, 'day' => 1, 'era' => 'xyz', 'eraYear' => 2025, 'calendar' => $calendar])); }, "xyz is not a valid era in calendar {$calendar}");
}
