...
$dateFromYearMonth = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['calendar' => $calendar, 'year' => $date->year, 'month' => $date->month, 'day' => $date->day]));
...
$dateFromYearMonthCode = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['calendar' => $calendar, 'year' => $date->year, 'monthCode' => $date->monthCode, 'day' => $date->day]));
...
$dateFromEraMonth = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['calendar' => $calendar, 'era' => $date->era, 'eraYear' => $date->eraYear, 'month' => $date->month, 'day' => $date->day]));
...
$dateFromEraMonthCode = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['calendar' => $calendar, 'era' => $date->era, 'eraYear' => $date->eraYear, 'monthCode' => $date->monthCode, 'day' => $date->day]));
