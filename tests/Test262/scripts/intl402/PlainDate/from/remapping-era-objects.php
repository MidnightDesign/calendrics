...
return \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(array_merge((is_object($fields) ? (array) $fields : $fields), ['calendar' => 'japanese'])), (object) JsUndefined::strip(['overflow' => $overflow]));
};
...
TemporalHelpers::assertPlainDate($test((object) ['era' => 'heisei', 'eraYear' => 1, 'monthCode' => 'M01', 'day' => 4]), 1989, 1, 'M01', 4, '01-04 Heisei 1 is remapped to 01-04 Showa 64', 'showa', 64);
TemporalHelpers::assertPlainDate($test((object) ['era' => 'heisei', 'eraYear' => 37, 'monthCode' => 'M04', 'day' => 25]), 2025, 4, 'M04', 25, 'Heisei 37 is remapped to Reiwa 7', 'reiwa', 7);
...
return \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(array_merge((is_object($fields) ? (array) $fields : $fields), ['calendar' => 'gregory'])), (object) JsUndefined::strip(['overflow' => $overflow]));
};
...
TemporalHelpers::assertPlainDate($testGregorian((object) ['era' => 'bce', 'eraYear' => 0, 'monthCode' => 'M04', 'day' => 25]), 1, 4, 'M04', 25, '0 BCE is remapped to 1 CE', 'ce', 1);
TemporalHelpers::assertPlainDate($testGregorian((object) JsUndefined::strip(['era' => 'bce', 'eraYear' => -20, 'monthCode' => 'M04', 'day' => 25])), 21, 4, 'M04', 25, '-20 BCE is remapped to 21 CE', 'ce', 21);
}
