...
// Source: tests/Test262/data/intl402/PlainDate/from/leap-year-hebrew.js
...
$startOfMonth = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => $leapYear, 'month' => $month, 'day' => 1, 'calendar' => $calendar]), $options);
...
$endOfMonth = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => $leapYear, 'month' => $month, 'day' => $day, 'calendar' => $calendar]), $options);
