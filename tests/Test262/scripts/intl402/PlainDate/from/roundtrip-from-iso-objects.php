...
$dateFromYearMonth = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['calendar' => $calendar, 'year' => $date->year, 'month' => $date->month, 'day' => $date->day]));
...
$dateFromYearMonthCode = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['calendar' => $calendar, 'year' => $date->year, 'monthCode' => $date->monthCode, 'day' => $date->day]));
...
$dateFromEraMonth = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['calendar' => $calendar, 'era' => $date->era, 'eraYear' => $date->eraYear, 'month' => $date->month, 'day' => $date->day]));
...
$dateFromEraMonthCode = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['calendar' => $calendar, 'era' => $date->era, 'eraYear' => $date->eraYear, 'monthCode' => $date->monthCode, 'day' => $date->day]));
...
$year2000 = new \Calendrics\Spec\PlainDate(2000, 1, 1, $calendar);
$testRoundtrip($year2000, $calendar, 'ISO date 2000-01-01');
$year1 = new \Calendrics\Spec\PlainDate(1, 1, 1, $calendar);
...
$date = new \Calendrics\Spec\PlainDate($isoYear, $isoMonth, $isoDay, $calendar);
