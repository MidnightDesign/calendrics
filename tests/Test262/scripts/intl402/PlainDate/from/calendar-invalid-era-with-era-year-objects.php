...
// Source: tests/Test262/data/intl402/PlainDate/from/calendar-invalid-era-with-era-year.js
...
Assert::throws(\RangeException::class, function () use (&$calendar) { return \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['month' => 1, 'day' => 1, 'era' => 'xyz', 'eraYear' => 2025, 'calendar' => $calendar])); }, "xyz is not a valid era in calendar {$calendar}");
}
