...
$preMeiji = \Calendrics\Spec\PlainDate::from((object) ['calendar' => 'japanese', 'era' => 'ce', 'eraYear' => 1800, 'month' => 6, 'day' => 15]);
...
$earlyMeiji = \Calendrics\Spec\PlainDate::from((object) ['calendar' => 'japanese', 'era' => 'ce', 'eraYear' => 1870, 'month' => 3, 'day' => 1]);
TemporalHelpers::assertPlainDate($earlyMeiji, 1870, 3, 'M03', 1, 'early pre-Meiji date', 'ce', 1870);
$bceDate = \Calendrics\Spec\PlainDate::from((object) ['calendar' => 'japanese', 'era' => 'bce', 'eraYear' => 100, 'month' => 1, 'day' => 1]);
TemporalHelpers::assertPlainDate($bceDate, -99, 1, 'M01', 1, 'BCE date', 'bce', 100);
$isoPreMeiji = new \Calendrics\Spec\PlainDate(1800, 6, 15);
...
$isoBce = new \Calendrics\Spec\PlainDate(-99, 1, 1);
