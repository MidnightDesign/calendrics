...
$startOfYear = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['calendar' => 'hebrew', 'year' => $year, 'monthCode' => 'M01', 'day' => 1]));
$firstDayOfPesach = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['calendar' => 'hebrew', 'year' => $year, 'monthCode' => 'M07', 'day' => 15]));
