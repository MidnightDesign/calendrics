...
// Source: tests/Test262/data/intl402/PlainDate/prototype/add/month-boundary-ethiopic.js
...
$date20001201 = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 2000, 'monthCode' => 'M12', 'day' => 1, 'calendar' => $calendar]), $options);
$dates = [$date20001201];
