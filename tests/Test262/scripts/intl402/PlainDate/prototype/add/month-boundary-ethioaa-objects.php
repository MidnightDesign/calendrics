...
// Source: tests/Test262/data/intl402/PlainDate/prototype/add/month-boundary-ethioaa.js
...
$date74921201 = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 7492, 'monthCode' => 'M12', 'day' => 1, 'calendar' => $calendar]), $options);
$dates = [$date74921201];
