...
// Source: tests/Test262/data/intl402/PlainDate/prototype/add/month-boundary-hebrew.js
...
$date57611201 = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 5761, 'monthCode' => 'M12', 'day' => 1, 'calendar' => $calendar]), $options);
$dates = [$date57611201];
