...
// Source: tests/Test262/data/intl402/PlainDate/prototype/add/month-boundary-coptic.js
...
$date17161201 = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 1716, 'monthCode' => 'M12', 'day' => 1, 'calendar' => $calendar]), $options);
$dates = [$date17161201];
