...
// Source: tests/Test262/data/intl402/PlainDate/prototype/add/month-boundary-buddhist.js
...
$date255512 = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 2555, 'monthCode' => 'M12', 'day' => 1, 'calendar' => $calendar]), $options);
$dates = [$date255512];
