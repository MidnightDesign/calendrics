...
$sameCalendarInstance = new \Temporal\Spec\PlainDate(2000, 5, 2, $localeCalendar);
...
$isoInstance = new \Temporal\Spec\PlainDate(2000, 5, 2, 'iso8601');
...
$differentCalendarInstance = new \Temporal\Spec\PlainDate(2000, 5, 2, $differentCalendar);
