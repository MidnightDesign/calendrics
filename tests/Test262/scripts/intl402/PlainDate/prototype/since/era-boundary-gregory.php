...
$bce5 = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['era' => 'bce', 'eraYear' => 5, 'monthCode' => 'M06', 'day' => 15, 'calendar' => $calendar]), $options);
$bce2 = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['era' => 'bce', 'eraYear' => 2, 'monthCode' => 'M12', 'day' => 1, 'calendar' => $calendar]), $options);
$bce1 = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['era' => 'bce', 'eraYear' => 1, 'monthCode' => 'M06', 'day' => 15, 'calendar' => $calendar]), $options);
$ce1 = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['era' => 'ce', 'eraYear' => 1, 'monthCode' => 'M06', 'day' => 15, 'calendar' => $calendar]), $options);
$ce2 = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['era' => 'ce', 'eraYear' => 2, 'monthCode' => 'M01', 'day' => 1, 'calendar' => $calendar]), $options);
$ce5 = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['era' => 'ce', 'eraYear' => 5, 'monthCode' => 'M06', 'day' => 15, 'calendar' => $calendar]), $options);
