...
// Source: tests/Test262/data/intl402/PlainDate/prototype/since/leap-months-hebrew.js
...
$common1Shevat = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 5783, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
...
$common1Nisan = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 5783, 'monthCode' => 'M07', 'day' => 1, 'calendar' => $calendar]), $options);
$leapShevat = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
$leapAdarI = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05L', 'day' => 1, 'calendar' => $calendar]), $options);
$leapAdarII = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M06', 'day' => 1, 'calendar' => $calendar]), $options);
$common2Shevat = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 5785, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
