...
// Source: tests/Test262/data/intl402/PlainDate/prototype/yearOfWeek/non-iso-week-of-year.js
...
Assert::sameValue(new \Calendrics\Spec\PlainDate(2024, 1, 1, $calendar)->yearOfWeek, null, "{$calendar} does not provide week numbers");
}
