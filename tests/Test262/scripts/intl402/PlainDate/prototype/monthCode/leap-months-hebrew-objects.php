...
// Source: tests/Test262/data/intl402/PlainDate/prototype/monthCode/leap-months-hebrew.js
...
$monthsInYear = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => $year, 'month' => 1, 'calendar' => $calendar, 'day' => 1]))->monthsInYear;
for ($month = 1; $month < $monthsInYear; $month++) {
$date = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(['year' => $year, 'month' => $month, 'calendar' => $calendar, 'day' => 1]));
if ($date->inLeapYear) {
