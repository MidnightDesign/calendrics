...
// Source: tests/Test262/data/intl402/PlainDate/prototype/with/basic-roc.js
...
$calendar = 'roc';
$cases = (object) JsUndefined::strip(['year2000' => (object) JsUndefined::strip(['era' => 'roc', 'year' => 89, 'eraYear' => 89, 'month' => 1, 'monthCode' => 'M01', 'day' => 1, 'calendar' => $calendar])]);
...
TemporalHelpers::assertPlainDate($afterWithYear, 130, 1, 'M01', 1, "{$name} after setting year", $inCal->era, 130);
}
