...
TemporalHelpers::assertPlainDate($date1443->with(['year' => 1442]), 1442, (float) (\Calendrics\Tests\Test262\Js::slice($monthCode, 1)), $monthCode, 29, "Changing the year from {$monthCode}-30 into 29-day {$monthCode} constrains", 'ah', 1442);
...
TemporalHelpers::assertPlainDate($date1442->with(['year' => 1443]), 1443, (float) (\Calendrics\Tests\Test262\Js::slice($monthCode, 1)), $monthCode, 29, "Changing the year from {$monthCode}-30 into 29-day {$monthCode} constrains", 'ah', 1443);
...
$date1443 = \Calendrics\Spec\PlainDate::from(JsUndefined::strip(['year' => 1443, 'monthCode' => $monthCode, 'day' => 30, 'calendar' => $calendar]), $options);
TemporalHelpers::assertPlainDate($date1443->with(['year' => 1444]), 1444, (float) (\Calendrics\Tests\Test262\Js::slice($monthCode, 1)), $monthCode, 29, "Changing the year from {$monthCode}-30 into 29-day {$monthCode} constrains", 'ah', 1444);
