...
$start = \Calendrics\Spec\PlainDate::from((object) JsUndefined::strip(array_merge((array) $startDate, ['calendar' => $calendar])));
$end = $start->add($duration);
$calculatedStart = $end->subtract($duration);
$expectedCalculatedStart = ($duration->years !== 0 && !\Calendrics\Tests\Test262\Js::endsWith($end->monthCode, 'L') ? $start->subtract((object) ['months' => 1]) : $start);
