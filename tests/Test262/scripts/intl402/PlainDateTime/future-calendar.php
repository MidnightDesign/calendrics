...
// Source: tests/Test262/data/intl402/PlainDateTime/future-calendar.js
...
Assert::throws(\RangeException::class, function () use (&$calendar) { new \Calendrics\Spec\PlainDateTime(1970, 1, 1, 0, 0, 0, 0, 0, 0, $calendar); }, "{$calendar} is not yet supported");
}
