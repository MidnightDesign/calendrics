...
$aa5500 = \Calendrics\Spec\PlainDateTime::from(JsUndefined::strip(['era' => 'aa', 'eraYear' => 5500, 'monthCode' => 'M01', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$am1 = \Calendrics\Spec\PlainDateTime::from(JsUndefined::strip(['era' => 'am', 'eraYear' => 1, 'monthCode' => 'M01', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$am2000 = \Calendrics\Spec\PlainDateTime::from(JsUndefined::strip(['era' => 'am', 'eraYear' => 2000, 'monthCode' => 'M06', 'day' => 15, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$am2005 = \Calendrics\Spec\PlainDateTime::from(JsUndefined::strip(['era' => 'am', 'eraYear' => 2005, 'monthCode' => 'M06', 'day' => 15, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$aa5450 = \Calendrics\Spec\PlainDateTime::from(JsUndefined::strip(['era' => 'aa', 'eraYear' => 5450, 'monthCode' => 'M07', 'day' => 12, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$aa5455 = \Calendrics\Spec\PlainDateTime::from(JsUndefined::strip(['era' => 'aa', 'eraYear' => 5455, 'monthCode' => 'M07', 'day' => 12, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$am5 = \Calendrics\Spec\PlainDateTime::from(JsUndefined::strip(['era' => 'am', 'eraYear' => 5, 'monthCode' => 'M01', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
