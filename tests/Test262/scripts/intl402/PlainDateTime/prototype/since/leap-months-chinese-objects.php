...
// Source: tests/Test262/data/intl402/PlainDateTime/prototype/since/leap-months-chinese.js
...
$common1Month4 = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 2000, 'monthCode' => 'M04', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$common1Month5 = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 2000, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$common1Month6 = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 2000, 'monthCode' => 'M06', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$leapMonth4 = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 2001, 'monthCode' => 'M04', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$leapMonth4L = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 2001, 'monthCode' => 'M04L', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$leapMonth5 = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 2001, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$common2Month4 = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 2002, 'monthCode' => 'M04', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$common2Month5 = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 2002, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
