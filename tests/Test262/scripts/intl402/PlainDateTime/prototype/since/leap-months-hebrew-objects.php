...
// Source: tests/Test262/data/intl402/PlainDateTime/prototype/since/leap-months-hebrew.js
...
$common1Shevat = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 5783, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
...
$common1Nisan = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 5783, 'monthCode' => 'M07', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$leapShevat = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$leapAdarI = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05L', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$leapAdarII = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 5784, 'monthCode' => 'M06', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
$common2Shevat = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => 5785, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
