...
// Source: tests/Test262/data/intl402/PlainDateTime/prototype/yearOfWeek/non-iso-week-of-year.js
...
Assert::sameValue(new \Calendrics\Spec\PlainDateTime(2024, 1, 1, 12, 34, 56, 987, 654, 321, $calendar)->yearOfWeek, null, "{$calendar} does not provide week numbers");
}
