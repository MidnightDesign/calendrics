...
// Source: tests/Test262/data/intl402/PlainDateTime/prototype/monthCode/leap-months-hebrew.js
...
$monthsInYear = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => $year, 'month' => 1, 'calendar' => $calendar, 'day' => 1, 'hour' => 12, 'minute' => 34]))->monthsInYear;
for ($month = 1; $month < $monthsInYear; $month++) {
$date = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => $year, 'month' => $month, 'calendar' => $calendar, 'day' => 1, 'hour' => 12, 'minute' => 34]));
if ($date->inLeapYear) {
