...
$dt1 = new \Calendrics\Spec\PlainDateTime(2000, 4, 2, 2);
$zdt1 = $dt1->toZonedDateTime($tz);
$zdt1_compatible = $dt1->toZonedDateTime($tz, (object) ['disambiguation' => 'compatible']);
$zdt1_earlier = $dt1->toZonedDateTime($tz, (object) ['disambiguation' => 'earlier']);
$zdt1_later = $dt1->toZonedDateTime($tz, (object) ['disambiguation' => 'later']);
...
$dt2 = new \Calendrics\Spec\PlainDateTime(2000, 10, 29, 1);
$zdt2 = $dt2->toZonedDateTime($tz);
$zdt2_compatible = $dt2->toZonedDateTime($tz, (object) ['disambiguation' => 'compatible']);
$zdt2_earlier = $dt2->toZonedDateTime($tz, (object) ['disambiguation' => 'earlier']);
$zdt2_later = $dt2->toZonedDateTime($tz, (object) ['disambiguation' => 'later']);
