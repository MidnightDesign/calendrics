...
$sameCalendarInstance = new \Calendrics\Spec\PlainDateTime(2000, 5, 2, 12, 34, 56, 987, 654, 321, $localeCalendar);
...
$isoInstance = new \Calendrics\Spec\PlainDateTime(2000, 5, 2, 12, 34, 56, 987, 654, 321, 'iso8601');
...
$differentCalendarInstance = new \Calendrics\Spec\PlainDateTime(2000, 5, 2, 12, 34, 56, 987, 654, 321, $differentCalendar);
