...
// Source: tests/Test262/data/intl402/PlainDateTime/from/basic-hebrew.js
...
$startOfMonth = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => $commonYear, 'month' => $month, 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
...
$endOfMonth = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['year' => $commonYear, 'month' => $month, 'day' => $day, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
