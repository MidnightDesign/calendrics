...
$date = \Calendrics\Spec\PlainDateTime::from((object) JsUndefined::strip(['era' => $era, 'eraYear' => $eraYear, 'monthCode' => 'M01', 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
