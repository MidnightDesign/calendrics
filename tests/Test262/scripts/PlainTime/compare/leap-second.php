...
$result1 = \Calendrics\Spec\PlainTime::compare($arg, new \Calendrics\Spec\PlainTime(23, 59, 59));
Assert::sameValue($result1, 0, 'leap second is a valid ISO string for PlainTime (first argument)');
$result2 = \Calendrics\Spec\PlainTime::compare(new \Calendrics\Spec\PlainTime(23, 59, 59), $arg);
Assert::sameValue($result2, 0, 'leap second is a valid ISO string for PlainTime (first argument)');
$arg = ['year' => 2016, 'month' => 12, 'day' => 31, 'hour' => 23, 'minute' => 59, 'second' => 60];
$result3 = \Calendrics\Spec\PlainTime::compare($arg, new \Calendrics\Spec\PlainTime(23, 59, 59));
Assert::sameValue($result3, 0, 'second: 60 is ignored in property bag for PlainTime (first argument)');
$result4 = \Calendrics\Spec\PlainTime::compare(new \Calendrics\Spec\PlainTime(23, 59, 59), $arg);
