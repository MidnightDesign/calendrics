...
$result = \Calendrics\Spec\PlainTime::compare($arg, $arg);
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::compare($arg, new \Calendrics\Spec\PlainTime(12, 34, 56, 987, 654, 321)); }, "\"{$arg}\" UTC offset without time is not valid for PlainTime (first argument)");
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::compare(new \Calendrics\Spec\PlainTime(12, 34, 56, 987, 654, 321), $arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainTime (second argument)");
}
