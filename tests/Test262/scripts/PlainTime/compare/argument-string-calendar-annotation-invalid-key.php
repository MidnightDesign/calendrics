...
// Source: tests/Test262/data/PlainTime/compare/argument-string-calendar-annotation-invalid-key.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::compare($arg, new \Calendrics\Spec\PlainTime(12, 34, 56, 987, 654, 321)); }, "annotation keys must be lowercase: {$arg} - {$descr} (first argument)");
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::compare(new \Calendrics\Spec\PlainTime(12, 34, 56, 987, 654, 321), $arg); }, "annotation keys must be lowercase: {$arg} - {$descr} (second argument)");
}
