...
// Source: tests/Test262/data/PlainTime/prototype/add/precision-exact-mathematical-values-1.js
...
$duration = \Calendrics\Spec\Duration::from((object) JsUndefined::strip(['microseconds' => 9_007_199_254_740_991, 'nanoseconds' => 1000]));
$time = \Calendrics\Spec\PlainTime::from((object) ['microsecond' => 1]);
