...
$result1 = $time->add(new \Calendrics\Spec\Duration(0, 0, 0, 0, 0, 0, 0, 0, 0, -2));
TemporalHelpers::assertPlainTime($result1, 1, 1, 1, 1, 0, 999, 'nanoseconds balance');
$result2 = $time->add(new \Calendrics\Spec\Duration(0, 0, 0, 0, 0, 0, 0, 0, -2));
TemporalHelpers::assertPlainTime($result2, 1, 1, 1, 0, 999, 1, 'microseconds balance');
$result3 = $time->add(new \Calendrics\Spec\Duration(0, 0, 0, 0, 0, 0, 0, -2));
TemporalHelpers::assertPlainTime($result3, 1, 1, 0, 999, 1, 1, 'milliseconds balance');
$result4 = $time->add(new \Calendrics\Spec\Duration(0, 0, 0, 0, 0, 0, -2));
TemporalHelpers::assertPlainTime($result4, 1, 0, 59, 1, 1, 1, 'seconds balance');
$result5 = $time->add(new \Calendrics\Spec\Duration(0, 0, 0, 0, 0, -2));
TemporalHelpers::assertPlainTime($result5, 0, 59, 1, 1, 1, 1, 'minutes balance');
$result6 = $time->add(new \Calendrics\Spec\Duration(0, 0, 0, 0, -2));
