...
Assert::throws(\TypeError::class, function () use (&$time) { return $time->toString(JsUndefined::strip(['fractionalSecondDigits' => \Temporal\Tests\Test262\JsSymbol::singleton()])); }, 'symbols are not numbers and cannot convert to strings');
