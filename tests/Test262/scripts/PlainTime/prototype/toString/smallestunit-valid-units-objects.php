...
Assert::throws(\RangeException::class, function () use (&$time, &$smallestUnit) { return $time->toString((object) JsUndefined::strip(['smallestUnit' => $smallestUnit])); }, "\"{$smallestUnit}\" is not a valid unit for the smallestUnit option");
}
