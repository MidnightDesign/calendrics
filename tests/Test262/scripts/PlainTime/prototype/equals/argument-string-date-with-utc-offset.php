...
// Source: tests/Test262/data/PlainTime/prototype/equals/argument-string-date-with-utc-offset.js
...
Assert::sameValue($result, true, "\"{$arg}\" is a valid UTC offset with time for PlainTime");
}
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->equals($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainTime");
}
