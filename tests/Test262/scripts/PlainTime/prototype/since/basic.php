...
$one = new \Calendrics\Spec\PlainTime(15, 23, 30, 123, 456, 789);
$two = new \Calendrics\Spec\PlainTime(14, 23, 30, 123, 456, 789);
$three = new \Calendrics\Spec\PlainTime(13, 30, 30, 123, 456, 789);
