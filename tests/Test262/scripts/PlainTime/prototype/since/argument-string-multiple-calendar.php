...
// Source: tests/Test262/data/PlainTime/prototype/since/argument-string-multiple-calendar.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->since($arg); }, "reject more than one calendar annotation if any critical: {$arg}");
}
