...
$actual->clear();
$identicalPropertyBag = TemporalHelpers::propertyBagObserver($actual, (object) ['hour' => 12, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321], 'other');
$instance->until($identicalPropertyBag, $options);
Assert::compareObserverTrace($actual, $expected, 'order of operations with identical times');
$actual->clear();
