...
TemporalHelpers::assertDuration($fourFortyEight->until($elevenFiftyNine, ['largestUnit' => 'seconds']), 0, 0, 0, 0, 0, 0, 25_863, 0, 0, 0, 'does not include higher units than necessary (largest unit is seconds)');
