...
$result2 = \Calendrics\Spec\PlainTime::from($arg, ['overflow' => 'reject']);
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::from($arg, ['overflow' => 'reject']); }, 'second: 60 is rejected in property bag for PlainTime with overflow: reject');
