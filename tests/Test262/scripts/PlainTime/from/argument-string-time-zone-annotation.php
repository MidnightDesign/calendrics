...
// Source: tests/Test262/data/PlainTime/from/argument-string-time-zone-annotation.js
...
$result = \Calendrics\Spec\PlainTime::from($arg);
TemporalHelpers::assertPlainTime($result, 12, 34, 56, 987, 654, 321, "time zone annotation ({$description})");
}
