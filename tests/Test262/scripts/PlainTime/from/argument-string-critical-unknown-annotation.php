...
// Source: tests/Test262/data/PlainTime/from/argument-string-critical-unknown-annotation.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::from($arg); }, "reject unknown annotation with critical flag: {$arg}");
}
