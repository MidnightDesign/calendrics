...
$explicit = \Calendrics\Spec\PlainTime::from($value, []);
TemporalHelpers::assertPlainTime($explicit, 12, 0, 0, 0, 0, 0, 'overflow is ignored');
$implicit = \Calendrics\Spec\PlainTime::from($value, []);
...
$propertyBag = ['hour' => 26];
$explicit = \Calendrics\Spec\PlainTime::from($propertyBag, []);
TemporalHelpers::assertPlainTime($explicit, 23, 0, 0, 0, 0, 0, 'default overflow is constrain');
$implicit = \Calendrics\Spec\PlainTime::from($propertyBag, []);
