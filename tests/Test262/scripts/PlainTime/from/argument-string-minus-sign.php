...
// Source: tests/Test262/data/PlainTime/from/argument-string-minus-sign.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::from($arg); }, "variant minus sign: {$arg}");
}
