...
// Source: tests/Test262/data/PlainTime/from/argument-string-time-separators.js
...
TemporalHelpers::assertPlainTime($result, 12, 34, 56, 987, 654, 321, "variant time separators ({$description})");
}
