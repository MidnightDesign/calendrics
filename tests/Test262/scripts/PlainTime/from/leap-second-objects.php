...
$result1 = \Calendrics\Spec\PlainTime::from($arg);
TemporalHelpers::assertPlainTime($result1, 23, 59, 59, 0, 0, 0, 'leap second is a valid ISO string for PlainTime');
$result2 = \Calendrics\Spec\PlainTime::from($arg, (object) ['overflow' => 'reject']);
...
$result3 = \Calendrics\Spec\PlainTime::from($arg);
TemporalHelpers::assertPlainTime($result3, 23, 59, 59, 0, 0, 0, 'second: 60 is ignored in property bag for PlainTime');
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::from($arg, (object) ['overflow' => 'reject']); }, 'second: 60 is rejected in property bag for PlainTime with overflow: reject');
