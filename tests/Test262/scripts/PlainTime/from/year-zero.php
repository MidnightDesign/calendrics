...
// Source: tests/Test262/data/PlainTime/from/year-zero.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainTime::from($arg); }, 'reject minus zero as extended year');
}
