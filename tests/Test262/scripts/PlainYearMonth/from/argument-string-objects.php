...
$plainYearMonth = \Calendrics\Spec\PlainYearMonth::from($input);
...
Assert::sameValue($plainYearMonth->toString((object) ['calendarName' => 'always']), '1976-11-01[u-ca=iso8601]', 'iso reference date');
}
...
Assert::sameValue($plainYearMonth->calendarId, 'iso8601', 'calendar string should be iso8601');
Assert::sameValue($plainYearMonth->toString((object) ['calendarName' => 'always']), '-009999-11-01[u-ca=iso8601]', 'iso reference date');
}
