...
// Source: tests/Test262/data/PlainYearMonth/from/argument-string-date-with-utc-offset.js
...
$result = \Calendrics\Spec\PlainYearMonth::from($arg);
TemporalHelpers::assertPlainYearMonth($result, 2019, 12, 'M12', "\"{$arg}\" is a valid UTC offset with time for PlainYearMonth");
}
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainYearMonth::from($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainYearMonth");
}
