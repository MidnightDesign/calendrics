...
$fields = (object) ['year' => 2000, 'month' => 13];
$explicit = \Calendrics\Spec\PlainYearMonth::from($fields);
Assert::sameValue($explicit->month, 12, 'default overflow is constrain');
$implicit = \Calendrics\Spec\PlainYearMonth::from($fields);
Assert::sameValue($implicit->month, 12, 'default overflow is constrain');
$lambda = \Calendrics\Spec\PlainYearMonth::from($fields, function () {  });
