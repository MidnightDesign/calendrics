...
// Source: tests/Test262/data/PlainYearMonth/from/options-read-before-algorithmic-validation.js
...
Assert::throws(\RangeException::class, function () use (&$options) { \Calendrics\Spec\PlainYearMonth::from((object) ['year' => 2025, 'monthCode' => 'M08L'], $options); }, 'exception thrown when month code is invalid for calendar');
