...
// Source: tests/Test262/data/PlainYearMonth/from/no-fractional-minutes-hours.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainYearMonth::from($arg); }, "{$description} not allowed in time string");
}
