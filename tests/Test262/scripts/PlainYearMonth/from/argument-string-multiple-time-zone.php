...
// Source: tests/Test262/data/PlainYearMonth/from/argument-string-multiple-time-zone.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainYearMonth::from($arg); }, "reject more than one time zone annotation: {$arg}");
}
