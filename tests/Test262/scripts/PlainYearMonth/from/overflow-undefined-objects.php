...
$explicit = \Calendrics\Spec\PlainYearMonth::from($value, (object) []);
TemporalHelpers::assertPlainYearMonth($explicit, 2000, 5, 'M05', 'overflow is ignored');
$implicit = \Calendrics\Spec\PlainYearMonth::from($value, (object) []);
...
$explicit = \Calendrics\Spec\PlainYearMonth::from($propertyBag, (object) []);
TemporalHelpers::assertPlainYearMonth($explicit, 2000, 12, 'M12', 'default overflow is constrain');
$implicit = \Calendrics\Spec\PlainYearMonth::from($propertyBag, (object) []);
