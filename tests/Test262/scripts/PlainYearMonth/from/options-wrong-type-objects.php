...
Assert::throws(\TypeError::class, function () use (&$value) { return \Calendrics\Spec\PlainYearMonth::from((object) ['year' => 2021, 'monthCode' => 'M01'], $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
