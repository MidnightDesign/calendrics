...
$result1 = \Calendrics\Spec\PlainYearMonth::from(['year' => 2023, 'monthCode' => 'M01', 'day' => 13]);
TemporalHelpers::assertPlainYearMonth($result1, 2023, 1, 'M01', 'reference day is 1 even if day is given', null, null, 1);
$result2 = \Calendrics\Spec\PlainYearMonth::from(['year' => 2021, 'monthCode' => 'M02', 'day' => 50], ['overflow' => 'constrain']);
...
$result3 = \Calendrics\Spec\PlainYearMonth::from(['year' => 2021, 'monthCode' => 'M02', 'day' => 50], ['overflow' => 'reject']);
