...
Assert::throws(\RangeException::class, function () use (&$options) { \Calendrics\Spec\PlainYearMonth::from(['year' => 2025, 'monthCode' => 'M08L'], $options); }, 'exception thrown when month code is invalid for calendar');
