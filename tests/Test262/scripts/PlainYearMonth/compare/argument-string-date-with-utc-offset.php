...
// Source: tests/Test262/data/PlainYearMonth/compare/argument-string-date-with-utc-offset.js
...
$result = \Calendrics\Spec\PlainYearMonth::compare($arg, $arg);
Assert::sameValue($result, 0, "\"{$arg}\" is a valid UTC offset with time for PlainYearMonth");
}
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainYearMonth::compare($arg, new \Calendrics\Spec\PlainYearMonth(2019, 6)); }, "\"{$arg}\" UTC offset without time is not valid for PlainYearMonth (first argument)");
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainYearMonth::compare(new \Calendrics\Spec\PlainYearMonth(2019, 6), $arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainYearMonth (second argument)");
}
