...
Assert::throws(\RangeException::class, function () use (&$ym, &$argument) { $ym->subtract($argument, ['overflow' => 'constrain']); }, 'subtracting a unit lower than months should throw, constrain');
Assert::throws(\RangeException::class, function () use (&$ym, &$argument) { $ym->subtract($argument, ['overflow' => 'reject']); }, 'subtracting a unit lower than months should throw, reject');
}
