...
// Source: tests/Test262/data/PlainYearMonth/prototype/subtract/options-wrong-type.js
...
Assert::throws(\TypeError::class, function () use (&$instance, &$value) { return $instance->subtract(['months' => 1], $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
}
