...
$laterSinceYear = $later->since($earlier, (object) ['smallestUnit' => 'years', 'roundingIncrement' => 4, 'roundingMode' => 'halfExpand']);
TemporalHelpers::assertDuration($laterSinceYear, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0, 'rounds to an increment of years');
$laterSinceMixed = $later->since($earlier, (object) ['smallestUnit' => 'months', 'roundingIncrement' => 5]);
TemporalHelpers::assertDuration($laterSinceMixed, 2, 5, 0, 0, 0, 0, 0, 0, 0, 0, 'rounds to an increment of months mixed with years');
$laterSinceMonth = $later->since($earlier, (object) ['largestUnit' => 'months', 'smallestUnit' => 'months', 'roundingIncrement' => 10]);
