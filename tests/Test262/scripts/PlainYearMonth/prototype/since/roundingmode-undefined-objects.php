...
// Source: tests/Test262/data/PlainYearMonth/prototype/since/roundingmode-undefined.js
...
$explicit1 = $later1->since($earlier, (object) ['smallestUnit' => 'year']);
TemporalHelpers::assertDuration($explicit1, 5, 0, 0, 0, 0, 0, 0, 0, 0, 0, 'default roundingMode is trunc');
$implicit1 = $later1->since($earlier, (object) ['smallestUnit' => 'year']);
...
$explicit2 = $later2->since($earlier, (object) ['smallestUnit' => 'year']);
TemporalHelpers::assertDuration($explicit2, 5, 0, 0, 0, 0, 0, 0, 0, 0, 0, 'default roundingMode is trunc');
$implicit2 = $later2->since($earlier, (object) ['smallestUnit' => 'year']);
