...
// Source: tests/Test262/data/PlainYearMonth/prototype/add/argument-duration-max.js
...
$minCases = [['-P273790Y8M', 'string with min years'], [JsUndefined::strip(['years' => -273_790, 'months' => -8]), 'property bag with min years'], ['-P3285488M', 'string with min months'], [JsUndefined::strip(['months' => -3_285_488]), 'property bag with min months']];
