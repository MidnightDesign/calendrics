...
// Source: tests/Test262/data/PlainYearMonth/prototype/until/blank-result.js
...
$d1 = new \Calendrics\Spec\PlainYearMonth(2025, 8);
$d2 = new \Calendrics\Spec\PlainYearMonth(2025, 8);
$result = $d1->until($d2);
