...
$laterSinceYear = $earlier->until($later, (object) ['smallestUnit' => 'years', 'roundingIncrement' => 4, 'roundingMode' => 'halfExpand']);
TemporalHelpers::assertDuration($laterSinceYear, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0, 'rounds to an increment of years');
$laterSinceMixed = $earlier->until($later, (object) ['smallestUnit' => 'months', 'roundingIncrement' => 5]);
TemporalHelpers::assertDuration($laterSinceMixed, 2, 5, 0, 0, 0, 0, 0, 0, 0, 0, 'rounds to an increment of months mixed with years');
$laterSinceMonth = $earlier->until($later, (object) ['largestUnit' => 'months', 'smallestUnit' => 'months', 'roundingIncrement' => 10]);
