...
// Source: tests/Test262/data/PlainYearMonth/prototype/until/options-wrong-type.js
...
Assert::throws(\TypeError::class, function () use (&$instance, &$value) { return $instance->until(new \Calendrics\Spec\PlainYearMonth(1976, 11), $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
}
