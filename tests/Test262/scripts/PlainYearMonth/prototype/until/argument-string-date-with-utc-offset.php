...
// Source: tests/Test262/data/PlainYearMonth/prototype/until/argument-string-date-with-utc-offset.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->until($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainYearMonth");
}
