...
// Source: tests/Test262/data/PlainYearMonth/prototype/until/options-object.js
...
$result1 = $instance->until(new \Calendrics\Spec\PlainYearMonth(1976, 11), (object) []);
TemporalHelpers::assertDuration($result1, -42, -11, 0, 0, 0, 0, 0, 0, 0, 0, 'options may be an empty plain object');
$result2 = $instance->until(new \Calendrics\Spec\PlainYearMonth(1976, 11), function () {  });
