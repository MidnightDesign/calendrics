...
// Source: tests/Test262/data/PlainYearMonth/prototype/equals/argument-string-date-with-utc-offset.js
...
$instance = new \Calendrics\Spec\PlainYearMonth(2019, 12);
...
Assert::sameValue($result, true, "\"{$arg}\" is a valid UTC offset with time for PlainYearMonth");
}
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->equals($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainYearMonth");
}
