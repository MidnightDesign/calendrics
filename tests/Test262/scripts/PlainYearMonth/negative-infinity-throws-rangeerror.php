...
Assert::throws(\RangeException::class, fn() => new \Calendrics\Spec\PlainYearMonth(-INF, 1), '');
Assert::throws(\RangeException::class, fn() => new \Calendrics\Spec\PlainYearMonth(1970, -INF), '');
Assert::throws(\RangeException::class, fn() => new \Calendrics\Spec\PlainYearMonth(1970, 1, 'iso8601', -INF), '');
...
Assert::throws(\RangeException::class, function () use (&$args_) { return new \Calendrics\Spec\PlainYearMonth(...$args_); }, $description);
