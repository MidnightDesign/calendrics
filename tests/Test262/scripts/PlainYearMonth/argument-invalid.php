...
Assert::throws(\RangeException::class, function () use (&$year, &$month, &$day) { return new \Calendrics\Spec\PlainYearMonth($year, $month, referenceISODay: $day); }, "year={$year}, month={$month}, day={$day}");
}
