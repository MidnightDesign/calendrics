...
Assert::throws(\RangeException::class, function () use (&$year, &$month, &$day) { return new \Calendrics\Spec\PlainYearMonth($year, $month, null, $day); }, "year={$year}, month={$month}, day={$day}");
}
