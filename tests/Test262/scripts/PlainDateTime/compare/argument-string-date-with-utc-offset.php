...
// Source: tests/Test262/data/PlainDateTime/compare/argument-string-date-with-utc-offset.js
...
$result = \Calendrics\Spec\PlainDateTime::compare($arg, $arg);
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::compare($arg, new \Calendrics\Spec\PlainDateTime(1976, 11, 18)); }, "\"{$arg}\" UTC offset without time is not valid for PlainDateTime (first argument)");
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::compare(new \Calendrics\Spec\PlainDateTime(1976, 11, 18), $arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainDateTime (second argument)");
}
