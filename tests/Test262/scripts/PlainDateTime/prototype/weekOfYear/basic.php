...
// Source: tests/Test262/data/PlainDateTime/prototype/weekOfYear/basic.js
...
for ($i = 29; $i <= 31; ++$i) {
$datetime = new \Calendrics\Spec\PlainDateTime(1975, 12, $i, 15, 23, 30, 123, 456, 789);
Assert::sameValue($datetime->weekOfYear, 1, "{$datetime} should be in week 1");
}
for ($i = 1; $i <= 4; ++$i) {
$datetime = new \Calendrics\Spec\PlainDateTime(1976, 1, $i, 15, 23, 30, 123, 456, 789);
Assert::sameValue($datetime->weekOfYear, 1, "{$datetime} should be in week 1");
}
for ($i = 5; $i <= 11; ++$i) {
$datetime = new \Calendrics\Spec\PlainDateTime(1976, 1, $i, 15, 23, 30, 123, 456, 789);
...
for ($i = 20; $i <= 26; ++$i) {
$datetime = new \Calendrics\Spec\PlainDateTime(1976, 12, $i, 15, 23, 30, 123, 456, 789);
...
for ($i = 1; $i <= 2; ++$i) {
$datetime = new \Calendrics\Spec\PlainDateTime(1977, 1, $i, 15, 23, 30, 123, 456, 789);
Assert::sameValue($datetime->weekOfYear, 53, "{$datetime} should be in week 53");
}
