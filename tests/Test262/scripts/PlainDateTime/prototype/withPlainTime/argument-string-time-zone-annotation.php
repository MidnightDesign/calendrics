...
// Source: tests/Test262/data/PlainDateTime/prototype/withPlainTime/argument-string-time-zone-annotation.js
...
TemporalHelpers::assertPlainDateTime($result, 1976, 11, 'M11', 18, 12, 34, 56, 987, 654, 321, "time zone annotation ({$description})");
}
