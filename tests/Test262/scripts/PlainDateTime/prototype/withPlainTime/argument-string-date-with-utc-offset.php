...
// Source: tests/Test262/data/PlainDateTime/prototype/withPlainTime/argument-string-date-with-utc-offset.js
...
$instance = new \Calendrics\Spec\PlainDateTime(1976, 11, 18, 15, 23);
...
TemporalHelpers::assertPlainDateTime($result, 1976, 11, 'M11', 18, 12, 34, 56, 987, 654, 321, "\"{$arg}\" is a valid UTC offset with time for PlainTime");
}
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->withPlainTime($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainTime");
}
