...
// Source: tests/Test262/data/PlainDateTime/prototype/withPlainTime/argument-string-too-many-decimals.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { $instance->withPlainTime($arg); }, 'no more than 9 decimal places are allowed');
}
