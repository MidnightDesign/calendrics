...
$instance = new \Calendrics\Spec\PlainDateTime(2000, 5, 2, 12, 34, 56, 987, 654, 321, 'iso8601');
...
$instance->until($otherDateTimePropertyBag, $createOptionsObserver((object) ['largestUnit' => 'years']));
...
// JS-only (trace covers a call skipped above, so the tracker is empty here): assert.compareArray(actual, expectedOpsForPrimitiveOptions, "other datetime fields are read before TypeError is thrown for primitive options");
$actual->clear();
