...
// Source: tests/Test262/data/PlainDateTime/prototype/until/argument-string-with-utc-designator.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->until($arg); }, 'String with UTC designator should not be valid as a PlainDateTime');
}
