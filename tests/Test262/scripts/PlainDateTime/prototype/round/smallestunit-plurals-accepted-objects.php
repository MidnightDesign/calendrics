...
TemporalHelpers::checkPluralUnitsAccepted(function ($smallestUnit) use (&$datetime) { return $datetime->round((object) JsUndefined::strip(['smallestUnit' => $smallestUnit])); }, $validUnits);
