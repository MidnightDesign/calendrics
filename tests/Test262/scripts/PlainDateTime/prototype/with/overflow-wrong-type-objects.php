...
Assert::throws(\TypeError::class, function () use (&$datetime) { return $datetime->with((object) ['minute' => 45], (object) JsUndefined::strip(['overflow' => \Temporal\Tests\Test262\JsSymbol::singleton()])); }, 'symbol');
