...
Assert::throws(\TypeError::class, function () use (&$instance) { return $instance->with((object) []); }, 'empty object not acceptable');
...
TemporalHelpers::assertPlainDateTime($instance->with((object) ['year' => 1965, 'nonsense' => true]), 1965, 5, 'M05', 2, 12, 34, 56, 987, 654, 321, 'unrecognized properties ignored & does not throw if recognized properties present)');
