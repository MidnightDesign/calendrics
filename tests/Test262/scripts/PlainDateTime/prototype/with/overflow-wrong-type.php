...
Assert::throws(\TypeError::class, function () use (&$datetime) { return $datetime->with(['minute' => 45], JsUndefined::strip(['overflow' => \Calendrics\Tests\Test262\JsSymbol::singleton()])); }, 'symbol');
