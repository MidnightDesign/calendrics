...
// Source: tests/Test262/data/PlainDateTime/prototype/with/timezone-throws.js
...
Assert::throws(\TypeError::class, function () use (&$datetime) { return $datetime->with((object) ['year' => 2021, 'timeZone' => 'UTC']); }, 'throws with timezone property');
