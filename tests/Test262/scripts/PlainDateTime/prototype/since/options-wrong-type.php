...
// Source: tests/Test262/data/PlainDateTime/prototype/since/options-wrong-type.js
...
Assert::throws(\TypeError::class, function () use (&$instance, &$value) { return $instance->since(new \Calendrics\Spec\PlainDateTime(1976, 11, 18), $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
}
