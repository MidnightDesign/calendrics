...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->since($arg); }, 'String with UTC designator should not be valid as a PlainDateTime');
}
