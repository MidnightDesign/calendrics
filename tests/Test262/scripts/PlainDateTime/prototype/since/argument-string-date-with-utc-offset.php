...
// Source: tests/Test262/data/PlainDateTime/prototype/since/argument-string-date-with-utc-offset.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->since($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainDateTime");
}
