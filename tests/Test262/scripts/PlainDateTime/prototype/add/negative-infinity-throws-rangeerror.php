...
$instance = \Calendrics\Spec\PlainDateTime::from(['year' => 2000, 'month' => 5, 'day' => 2, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321]);
foreach ($overflows as $overflow) {
foreach ($fields as $field) {
Assert::throws(\RangeException::class, function () use (&$instance, &$field, &$overflow) { return $instance->add(JsUndefined::strip([$field => -INF]), JsUndefined::strip(['overflow' => $overflow])); }, '');
}
}
$calls = 0;
