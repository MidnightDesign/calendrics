...
// Source: tests/Test262/data/PlainDateTime/prototype/equals/argument-string-limits.js
...
Assert::throws(\RangeException::class, function () use (&$instance, &$arg) { return $instance->equals($arg); }, "\"{$arg}\" is outside the representable range of PlainDateTime");
}
