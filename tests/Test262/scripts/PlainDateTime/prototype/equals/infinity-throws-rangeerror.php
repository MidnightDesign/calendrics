...
Assert::throws(\RangeException::class, function () use (&$instance, &$base, &$prop, &$inf) { return $instance->equals(JsUndefined::strip(array_merge($base, [$prop => $inf]))); }, "{$prop} property cannot be {$inf}");
$calls = new \Calendrics\Tests\Test262\ObserverTrace();
$obj = TemporalHelpers::toPrimitiveObserver($calls, $inf, $prop);
Assert::throws(\RangeException::class, function () use (&$instance, &$base, &$prop, &$obj) { return $instance->equals(JsUndefined::strip(array_merge($base, [$prop => $obj]))); }, '');
