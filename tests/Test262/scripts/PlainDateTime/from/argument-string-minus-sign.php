...
// Source: tests/Test262/data/PlainDateTime/from/argument-string-minus-sign.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::from($arg); }, "variant minus sign: {$arg}");
}
