...
// Source: tests/Test262/data/PlainDateTime/from/argument-string-time-zone-annotation.js
...
TemporalHelpers::assertPlainDateTime($result, 1976, 11, 'M11', 18, 15, 23, 0, 0, 0, 0, "time zone annotation ({$description})");
}
