...
Assert::throws(\RangeException::class, function () use (&$options) { \Calendrics\Spec\PlainDateTime::from(['year' => 2025, 'monthCode' => 'M08L', 'day' => 14], $options); }, 'exception thrown when month code is invalid for calendar');
