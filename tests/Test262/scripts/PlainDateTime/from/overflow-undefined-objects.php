...
$explicit = \Calendrics\Spec\PlainDateTime::from($value, (object) []);
TemporalHelpers::assertPlainDateTime($explicit, 2000, 5, 'M05', 2, 12, 0, 0, 0, 0, 0, 'overflow is ignored');
$implicit = \Calendrics\Spec\PlainDateTime::from($value, (object) []);
...
$propertyBag = (object) ['year' => 2000, 'month' => 13, 'day' => 34, 'hour' => 12];
$explicit = \Calendrics\Spec\PlainDateTime::from($propertyBag, (object) []);
TemporalHelpers::assertPlainDateTime($explicit, 2000, 12, 'M12', 31, 12, 0, 0, 0, 0, 0, 'default overflow is constrain');
$implicit = \Calendrics\Spec\PlainDateTime::from($propertyBag, (object) []);
