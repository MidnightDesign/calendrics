...
$result1 = \Calendrics\Spec\PlainDateTime::from($arg);
...
$result2 = \Calendrics\Spec\PlainDateTime::from($arg);
...
$result3 = \Calendrics\Spec\PlainDateTime::from($arg);
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::from($arg, (object) ['overflow' => 'reject']); }, 'second: 60 is rejected in property bag for PlainDateTime with overflow: reject');
