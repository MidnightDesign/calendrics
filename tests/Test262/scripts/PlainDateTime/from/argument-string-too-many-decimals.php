...
// Source: tests/Test262/data/PlainDateTime/from/argument-string-too-many-decimals.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { \Calendrics\Spec\PlainDateTime::from($arg); }, 'no more than 9 decimal places are allowed');
}
