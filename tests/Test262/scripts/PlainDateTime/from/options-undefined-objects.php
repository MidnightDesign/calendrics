...
$explicit = \Calendrics\Spec\PlainDateTime::from($fields);
Assert::sameValue($explicit->month, 12, 'default overflow is constrain');
$implicit = \Calendrics\Spec\PlainDateTime::from($fields);
Assert::sameValue($implicit->month, 12, 'default overflow is constrain');
$lambda = \Calendrics\Spec\PlainDateTime::from($fields, function () {  });
