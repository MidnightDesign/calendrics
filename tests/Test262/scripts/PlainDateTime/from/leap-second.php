...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::from($arg, ['overflow' => 'reject']); }, 'second: 60 is rejected in property bag for PlainDateTime with overflow: reject');
