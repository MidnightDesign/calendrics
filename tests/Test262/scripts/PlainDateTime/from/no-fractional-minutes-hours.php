...
// Source: tests/Test262/data/PlainDateTime/from/no-fractional-minutes-hours.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::from($arg); }, "{$description} not allowed in time string");
}
