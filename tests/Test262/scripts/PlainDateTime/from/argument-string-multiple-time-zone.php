...
// Source: tests/Test262/data/PlainDateTime/from/argument-string-multiple-time-zone.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::from($arg); }, "reject more than one time zone annotation: {$arg}");
}
