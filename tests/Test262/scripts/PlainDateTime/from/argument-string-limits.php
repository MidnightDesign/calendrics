...
// Source: tests/Test262/data/PlainDateTime/from/argument-string-limits.js
...
\Calendrics\Spec\PlainDateTime::from($arg);
}
$invalidStrings = ['-271821-04-19', '-271821-04-19T00:00', '+275760-09-14', '+275760-09-14T00:00'];
foreach ($invalidStrings as $arg) {
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::from($arg); }, "\"{$arg}\" is outside the representable range of PlainDateTime");
}
