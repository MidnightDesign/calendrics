...
// Source: tests/Test262/data/PlainDateTime/from/argument-propertybag-calendar-invalid-iso-string.js
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Calendrics\Spec\PlainDateTime::from($arg); }, "{$description} is not a valid calendar ID");
}
