...
Assert::throws(\RangeException::class, function () use (&$arg) { return new \Calendrics\Spec\PlainDateTime(2000, 5, 2, 15, 23, 30, 987, 654, 321, $arg); }, "{$description} is not a valid calendar ID");
}
